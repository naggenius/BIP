...
import com.socgen.bip.service.RejetFacturesEbisDtoReader;
import com.socgen.bip.user.UserBip;

public class ExporterLogsFacturesEbisAction extends AutomateAction implements
		BipConstantes {
	...
	{
		String signatureMethode = "ExporterLogsFacturesEbisAction-creer( mapping, form , request,  response,  errors )";
		...
		try {
			...
			RejetFacturesEbisDtoReader rejetFactureDtoReader = new RejetFacturesEbisDtoReader();
			collection = rejetFactureDtoReader.getRejetFacturesEbisDtoExportExcell(hParamProc);
			...
			String prefix=myResources.getString("excell.ebis.factures.logs.fichier.prefix");
			...
			FeuilleExcellExportRejetFacturesEbis exportExcellEbisRejet = new FeuilleExcellExportRejetFacturesEbis(collection,lLocal);
