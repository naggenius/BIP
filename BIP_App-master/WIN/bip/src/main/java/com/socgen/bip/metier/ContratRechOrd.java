...
public class ContratRechOrd {
	...
	public ContratRechOrd(String fournisseur, String siren, String nom, String prenom, String ident, String num_contrat, String cav, String lib_dpg, String datdeb, String datfin, String code) {
		super();
		this.code = code;
