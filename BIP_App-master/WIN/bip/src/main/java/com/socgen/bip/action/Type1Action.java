 ...
 * 
 * Action de mise à jour des Type1 chemin : Administration/Tables/ mise à
...
public class Type1Action extends AutomateAction implements BipConstantes {
	...
	/**
	 * Action qui permet de visualiser les données liées à un code Type1 pour la
	...
	protected ActionForward consulter(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (msg) {
				// le code Type1 n'existe pas, on récupère le message
