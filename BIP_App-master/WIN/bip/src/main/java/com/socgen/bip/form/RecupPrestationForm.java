...
public class RecupPrestationForm extends AutomateForm
{
	private String nomRecherche ;
	private InfosPersonne[] listeNomsPrestation;
	 ...
	 * @return
	 */
	public InfosPersonne[] getListeNomsPrestation() {
		return listeNomsPrestation;
	}

	/**
	 * @param personnes
	 */
	public void setListeNomsPrestation(InfosPersonne[] personnes) {
		listeNomsPrestation = personnes;
	}
