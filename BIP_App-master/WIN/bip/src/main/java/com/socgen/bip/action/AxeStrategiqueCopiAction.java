 ...
 *
 */
public class AxeStrategiqueCopiAction extends AutomateAction implements BipConstantes {
 
	
	private static String PACK_INSERT = "copi.axestrategique.creer.proc";
  
	private static String PACK_DELETE = "copi.axestrategique.supprimer.proc";
