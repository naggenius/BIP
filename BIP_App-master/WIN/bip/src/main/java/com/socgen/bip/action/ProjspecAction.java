 ...
 * 
 * Action de mise à jour des Projspec chemin : Administration/Tables/ mise à
...
public class ProjspecAction extends AutomateAction implements BipConstantes {
	...
	/**
	 * Action qui permet de visualiser les données liées à un code Projspec pour
	...
	protected ActionForward consulter(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (msg) {
				// le code Projspec n'existe pas, on récupère le message
