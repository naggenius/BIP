 ...
 * 
 * Action de mise à jour des Type2 chemin : Administration/Tables/ mise à
...
public class Type2Action extends AutomateAction implements BipConstantes {
	...
	/**
	 * Action qui permet de visualiser les données liées à un code Type2 pour la
	...
	protected ActionForward consulter(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (msg) {
				// le code Type2 n'existe pas, on récupère le message
