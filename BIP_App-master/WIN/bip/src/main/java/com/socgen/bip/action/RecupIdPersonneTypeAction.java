...
public class RecupIdPersonneTypeAction extends AutomateAction {

	private static String PACK_SELECT = "recup.id.personne_type.proc";
	 ...
	 */
	public RecupIdPersonneTypeAction() {
		super();
	}
				...
				if (paramOut.getNom().equals("curseur")) {
					...
					try {
						...
						while (rset.next() && compteur < 99) {
							...
							vListe.add(new InfosPersonne(rset.getString(1),
									rset.getString(3), rset.getString(2),
									buildUrl(hrefId,rset.getString(2),rset.getString(3)), 
									rset.getString(4)));
							compteur++;
						}
						if (rset != null)
	...
	public String buildUrl(int idPersonne, String nomPersonne, String prenomPersonne) {
		return ("<a href=\"javascript:fill('" + idPersonne + "');fill2('" + nomPersonne + "');fill3('" + prenomPersonne + "');Quitter();\">");
	}
