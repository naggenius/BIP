...
/**
 * @author BAA - 15/09/2005
 * 
 * Action permettant de récupérer un ID d'un client via une fenêtre Popup
 * 
 * 
 */

public class RecupIdMoAction extends AutomateAction {

	private static String PACK_SELECT = "recup.id.mo.proc";
