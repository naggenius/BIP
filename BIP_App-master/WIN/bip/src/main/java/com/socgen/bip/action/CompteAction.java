 ...
 * 
 * Action de mise à jour des Compte chemin : Administration/Tables/ mise à
...
public class CompteAction extends AutomateAction implements BipConstantes {
	...
	/**
	 * Action qui permet de créer un code Compte
	 */
	...
	/**
	 * Action qui permet de visualiser les données liées à un code Compte pour
	...
	protected ActionForward consulter(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (msg) {
				// le code Compte n'existe pas, on récupère le message
