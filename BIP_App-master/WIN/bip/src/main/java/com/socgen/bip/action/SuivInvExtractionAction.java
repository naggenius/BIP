...
import com.socgen.bip.form.SuivInvExtractionForm;
 ...
 */
public class SuivInvExtractionAction extends ReportAction
{
	/**
	 * Constructeur
	 * Aucun traitement
	 */
	public SuivInvExtractionAction()
	{
		super();
	}
										...
										throws ReportException, IOException
	{
		...
		SuivInvExtractionForm siForm = (SuivInvExtractionForm)form;
