...
public class AutocompleteSociete extends AutomateAction {
	
	private static String PACK_SELECT = "recup.id.societeAjax.proc";
					...
					try {
						...
						while (rset.next()) {
							...
							if (rset.getString(3) == null)
								...
								siren =rset.getString(3);
							String lib = String.format("%-4.4s",rset.getString(1))+ " - " +
							String.format("%-4.4s",rset.getString(7))+ " - " +
							String.format("%-25.25s",rset.getString(2))+ " - " +
							String.format("%-9.9s",siren);
