...
public class RecupCodcamoForm extends AutomateForm
{
	private String nomRecherche ;
	private InfosPersonne[] listeNomsCodcamo;
	...
	public InfosPersonne[] getListeNomsCodcamo() {
		return listeNomsCodcamo;
	}

	public void setListeNomsCodcamo(InfosPersonne[] listeNomsCodcamo) {
		this.listeNomsCodcamo = listeNomsCodcamo;
	}
	/**
	 * @return
	 */
