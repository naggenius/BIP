...
public class RecupIdProjetForm extends AutomateForm
{
	private String nomRecherche ;
	private InfosPersonne[] listeNomsProjet;
	 ...
	 * @return
	 */
	public InfosPersonne[] getListeNomsProjet() {
		return listeNomsProjet;
	}
