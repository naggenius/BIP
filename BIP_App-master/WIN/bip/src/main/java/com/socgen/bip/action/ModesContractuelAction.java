 ...
 * 
 * Action de mise à jour des modes contractuels : Administration/Tables/ mise à
...
public class ModesContractuelAction extends AutomateAction implements BipConstantes {
	...
	protected ActionForward creer(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (!message.equals("")) {
				...
				message = "Mode Contractuel déjà existant";
	...
	/**
	 * Action qui permet de visualiser les données liées à un mode contractuel pour
	...
	protected ActionForward consulter(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (msg) {
				// le code contractuel n'existe pas, on récupère le message
