...
/**
 * @author S LALLIER
 * Formulaire de base pour le gestion des lignes d'investissement.
 */
public class LigneInvestissementForm extends AutomateForm {
	/**
	...
	*/
	...
	/**
	 * Top récurrent / Projet
	 */
	private String toprp;
	...
	public String getCominv() {
		return cominv;
	}
	public String getToprp() {
		return toprp;
	}
	...
	public void setCominv(String string) {
		cominv = string;
	}
	public void setToprp(String string) {
		toprp = string;
	}
	...
	public void setIsNotifiee(boolean b) {
		isNotfiee = b;
	}

	public boolean getIsNotifiee() {
		return isNotfiee;
	}
}
