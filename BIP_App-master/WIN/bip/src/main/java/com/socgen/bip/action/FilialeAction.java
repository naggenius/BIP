 ...
 * 
 * Action de mise à jour des Filiales chemin : Administration/Tables/ mise à
...
public class FilialeAction extends AutomateAction implements BipConstantes {
	...
	/**
	 * Action qui permet de visualiser les données liées à un code Filiale pour
	...
	protected ActionForward consulter(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (msg) {
				// le code Filiale n'existe pas, on récupère le message
