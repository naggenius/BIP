...
import com.socgen.bip.form.RecupJulioDirectionForm;
...
public class RecupJulioDirectionAction extends AutomateAction {

	private static String PACK_SELECT = "recup.id.personne.proc";
	...
	private static String PACK_SELECT_DIRECTION = "recup.id.direction.proc";
	 ...
	 */
	public RecupJulioDirectionAction() {
		super();
	}
	...
	protected ActionForward initialiser(ActionMapping mapping, ActionForm form,
		...
		RecupJulioDirectionForm rechercheForm = (RecupJulioDirectionForm) form;
		int linesPerPage = 10;
		int compteur = 0;
		...
		try {
			vParamOut = jdbc.getResult(hParams,
					configProc, PACK_SELECT_DIRECTION);
		...
		logBipUser.exit(signatureMethode);
		request.setAttribute("RecupJulioDirectionForm", rechercheForm);
