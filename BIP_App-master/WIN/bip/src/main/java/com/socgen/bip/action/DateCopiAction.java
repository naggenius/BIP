...
public class DateCopiAction extends AutomateAction implements BipConstantes {
	
	private static String PACK_INSERT = "dateCopi.creer.proc";
	
	private static String PACK_DELETE = "dateCopi.supprimer.proc";
	...
	protected ActionForward creer(ActionMapping mapping, ActionForm form, 
		 ...
		 Vector vParamOut = new Vector();
		    ...
		    String message=null;
		    DateCopiForm bipForm = (DateCopiForm) form;
		   
		    String signatureMethode = "DateCopiAction -valider(ActionMapping mapping, ActionForm form, String mode, HttpServletRequest request, HttpServletResponse response, ActionErrors errors )";
