 ...
 * 
 * Formulaire pour mise à jour des Centres de frais chemin :
 * Administration/Tables/ mise à jour/Centre de frais pages : bCentrefraisAd.jsp
...
public class CentrefraisAction extends AutomateAction {
	...
	/**
	 * Action qui permet de créer un code Centrefrais
	 */
	...
	/**
	 * Action qui permet de visualiser les données liées à un code Centrefrais
	...
	protected ActionForward consulter(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (msg) {
				// le code Centrefrais n'existe pas, on récupère le message
