 ...
 * 
 * Action de mise à jour des tables de répartition chemin :
 * Administration/Lignes BIP/Répartition JH/Table de répartition pages :
...
public class TableRepartAction extends AutomateAction implements BipConstantes {
	...
	/**
	 * Action qui permet de visualiser les données liées à un code table de
	 * répartition pour la modification et la suppression
	 */
	protected ActionForward consulter(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (msg) {
				// le code Table de répartition n'existe pas, on récupère le
				// message
