...
import com.socgen.bip.form.ExceptionCopiForm;
import com.socgen.bip.form.ProjetForm;
import com.socgen.bip.form.RubriqueForm;
import com.socgen.cap.fwk.exception.BaseException;

public class ExceptionCopiAction extends AutomateAction implements BipConstantes {
	
	private static String PACK_INSERT = "exceptionCopi.creer.proc";
	
	private static String PACK_DELETE = "exceptionCopi.supprimer.proc";
	...
	protected ActionForward creer(ActionMapping mapping, ActionForm form, 
		 ...
		 Vector vParamOut = new Vector();
		    ...
		    String message=null;
		    ExceptionCopiForm bipForm = (ExceptionCopiForm) form;
			...
			message = BipException.getMessageFocus(
					BipException.getMessageOracle(be.getInitialException()
							.getMessage()), form);
			((ExceptionCopiForm) form).setMsgErreur(message);
