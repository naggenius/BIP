...
public class AutocompleteFournisseur extends AutomateAction {
	
	private static String PACK_SELECT = "recup.id.fournisseurAjax.proc";
				...
				if (paramOut.getNom().equals("curseur")) {
					...
					try {
						...
						while (rset.next()) {
							...
							// un vector							
							vListe.add(compteur,new AutocompleteAttribut(rset.getString(2), 
									rset.getString(1)));
							compteur++;
						}
						if (rset != null)
