      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Rattachement 
            en masse des lignes BIP - dossier projet<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
                    <html:hidden property="mode" value="DP"/>
            		<html:hidden property="table" value="DP"/>
                      ...
                      <tr> 
                        ...
                        <td align=center><b><bean:write name="lienLigneForm"  property="dpcode" /> - <bean:write name="lienLigneForm"  property="dplib" /> </b>
