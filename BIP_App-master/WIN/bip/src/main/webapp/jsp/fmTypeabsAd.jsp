...
<html:html locale="true"> <!-- #EndEditable --> <!-- #BeginTemplate "/Templates/Page_filtre_maj.dwt" --><head>
...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (form.gipabs && !ChampObligatoire(form.gipabs,"le type d'absence")) return false;
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Bouclage 
            Jour/Homme - Gestion des types d'absences <!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/typeAbs"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>
              <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td align=center  ><b>Type d'absence : </b></td>
                  <td >
				  <html:text property="gipabs" styleClass="input" size="7" maxlength="6" onchange="return VerifierAlphaMax(this);"/> 
                  </td>
                </tr>
                <tr> 
                  <td align=center>&nbsp;</td>
