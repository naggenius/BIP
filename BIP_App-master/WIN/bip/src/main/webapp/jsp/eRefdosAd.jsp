...
<bip:VerifUser page="jsp/eRefdosAd.jsp"/>
            ...
            <table width="100%" border="0">
                ...
                <tr> 
                  <td> 
					...
					<tr>
						<td colspan=2><b>Entrez le code DPG du p&ocirc;le dont vous voulez la liste dossier projet :</b></td>
					</tr>
					<tr>
