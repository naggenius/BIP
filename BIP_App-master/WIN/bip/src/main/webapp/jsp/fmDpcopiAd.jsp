...
function MessageInitial()
{
  ...
  if (Focus != "") (eval( "document.forms[0]."+Focus )).focus();
	  ...
	  document.forms[0].dp_copi.focus();
   }
}
...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (!ChampObligatoire(form.dp_copi, "un code dossier projet COPI")) return false;
...
function rechercheID(){
	window.open("/recupDPCopi.do?action=initialiser&type=creation&nomChampDestinataire=dp_copi&windowTitle=Recherche Code Dossier Projet COPI"  ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width=450, height=450") ;
	return ;
}  
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise à jour des Dossier projet COPI<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/dpcopi"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>
		       <table width="100%" border="0" cellpadding=2 cellspacing=2 class="tableBleu">
                      ...
                      <tr> 
                        <td align="center"><b>Code Dossier projet COPI </b> : 
                       <html:text property="dp_copi" styleClass="input" size="6" maxlength="6" onchange="this.value = this.value.toUpperCase();return VerifierAlphaMax(this);"/>&nbsp;&nbsp;
