...
{
   tabVerif["codlocalisation"] = "VerifierAlphaMaxCarSpecLocalisation(document.forms[0].codlocalisation)";
...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (form.codlocalisation && !ChampObligatoire(form.codlocalisation,"le code localisation")) return false;
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des localisations<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/majLocalisations"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td align=center><b>Code Localisation
                    : &nbsp </b></td>
                  <td> 
                     <html:text property="codlocalisation" styleClass="input" size="2" maxlength="2" onchange="return VerifierAlphaMaxCarSpecLocalisation(this);"/>
				</td>
                </tr>
                <tr> 
                  <td align=center>&nbsp;</td>
