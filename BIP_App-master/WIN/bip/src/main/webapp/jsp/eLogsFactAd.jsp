...
<bip:VerifUser page="jsp/eLogsFactAd.jsp"/>
                ...
                <tr> 
                  <td> 
					...
					<table border=0 cellspacing=2 cellpadding=2 class="tableBleu">
					  ...
					  <tr>
                        <td align="center"><b>Numéro Expense :</b></td>
                       <td> 
                     <html:text property="p_param6" styleClass="input" size="9" maxlength="8" onchange="supprchamp('p_param7');" />
                      	</td>
					  </tr>
					  <tr>
                        <td align="center" colspan="2">ou</td>
                       
					  </tr>
					  <tr>
                        <td align="center"><b>Numéro Facture :</b></td>
                       <td> 
                     <html:text property="p_param7" styleClass="input" size="16" maxlength="15" onchange="supprchamp('p_param6');" />
                      	</td>
					  </tr>
		   		    </table>
					</div>
