...
function MessageInitial()
{
   ...
   tabVerif["dpcode"]  = "VerifierNum(document.forms[0].dpcode,5,0)";
   if (Message != "") {
      alert(Message);
   }
...
function ValiderEcran(form)
{
  if (blnVerification==true) {
     ...
     if (form.action.value!="valider")
  		form.action.value ="suite";
     if (!ChampObligatoire(form.dpcode, "un code dossier projet")) return false;
  }
...
function nextFocusCreer(){document.forms[0].boutonValider.focus();}
</script>
<!-- #EndEditable --> 
</head>
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td> <!-- #BeginEditable "debut_form" --><html:form action="/lienDp"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable --> 
            <div align="center"><!-- #BeginEditable "contenu" -->
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
            
<html:hidden property="arborescence" value="<%= arborescence %>"/>
<html:hidden property="action" value="suite"/>
            <html:hidden property="table" value="DP"/>
              <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  ...
                  <td><html:text property="dpcode" styleClass="input" size="5" maxlength="5" onchange="return VerifierNum(this,5,0);"/>
                  <a href="javascript:rechercheDP();" onFocus="javascript:nextFocusCreer();"><img border=0 src="/images/p_zoom_blue.gif"  alt="Rechercher Code dossier projet" title="Rechercher Code dossier projet" align="absbottom"></a>
                   </td>
                </tr>
                <tr> 
                  <td align=center colspan=2>&nbsp;</td>
