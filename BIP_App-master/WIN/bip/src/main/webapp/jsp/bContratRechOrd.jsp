...
<jsp:useBean id="ContratRechOrdForm" scope="request" class="com.socgen.bip.form.ContratRechOrdForm" />
...
<bip:VerifUser page="jsp/bContratRechOrd.jsp"/> 
...
function MessageInitial()
{
   ...
   var Message="<bean:write filter="false"  name="ContratRechOrdForm"  property="msgErreur" />";
   var Focus = "<bean:write name="ContratRechOrdForm"  property="focus" />";
   if (Message != "") {
      alert(Message);
   }
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td> <!-- #BeginEditable "debut_form" --><html:form action="/ContratRechOrd"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable --> 
...
try
{
if (listeRechercheId.getCount()==0 && ( !ContratRechOrdForm.getIdent().equals(null) || !ContratRechOrdForm.getSiren().equals(null) || !ContratRechOrdForm.getNum_contrat().equals(null)) ) {%><!--  IF -->
<table width="100%" border="0" cellpadding=2 cellspacing=2 class="tableBleu">
   <tr> 
      <td>&nbsp; </td>
   </tr>
...
%>     
    <logic:iterate id="element"  name="listeRechercheId"  length="<%=listeRechercheId.getCountInBlock()%>" 
          					offset="<%=listeRechercheId.getOffset(0)%>" type="com.socgen.bip.metier.ContratRechOrd" indexId="index"> 
...
com.socgen.bip.commun.form.AutomateForm formWebo = ContratRechOrdForm ;
%>
