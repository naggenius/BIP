...
<bip:VerifUser page="jsp/eLogsCoutsStandards.jsp"/>
            ...
            <table width="100%" border="0">
                ...
                <tr> 
                  <td> 
					...
					<tr>
						<td colspan=3 class="lib"><b>Log des Co&ucirc;ts Standards : </b></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					...
					<tr>
						<td class="lib">Date début des Logs :</td>
