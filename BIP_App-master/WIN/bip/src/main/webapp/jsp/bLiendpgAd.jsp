      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Rattachement 
            en masse des lignes BIP - DPG<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
                    <html:hidden property="mode" value="DPG"/>
            		<html:hidden property="table" value="DPG"/>
                      ...
                      <tr> 
                        <td align=center><b>DPG : </b></td>
                        <td align=center><b><bean:write name="lienLigneForm"  property="codsg" /> - <bean:write name="lienLigneForm"  property="libdsg" /> </b>
