...
<bip:VerifUser page="jsp/eResidAd.jsp"/>
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						<td colspan=1 align=right class="lib"><B>Code ressource :</B></td>
						<td colspan=1 align=left><html:text property="p_param6" styleClass="input"  size="5" maxlength="5" onchange="return VerifFormat(this.name);"/>&nbsp;&nbsp;                           
                          <a href="javascript:rechercheID();" onFocus="javascript:nextFocusLoupePersonne();"><img border=0 src="/images/p_zoom_blue.gif" alt="Rechercher Identifiant" title="Rechercher Identifiant" align="absbottom"></a></td>
					</tr>
					<tr><td colspan=5 align="center">&nbsp;</td></tr>
					<!-- #EndEditable -->
			   		</table>
