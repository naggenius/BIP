                ...
                <tr> 
                  <td> 
					...
					<tr>
						...
						<td colspan=2 class="lib">Du :   </td>
						<td><html:text property="p_param6" styleClass="input"  size="10" maxlength="10" onchange="return VerifFormat(this.name);"/> 
						
						<td class="lib">au :       </td>
						<td><html:text property="p_param7" styleClass="input"  size="10" maxlength="10" onchange="return VerifFormat(this.name);"/>
					</tr>
					 <tr>
						<td colspan=3 align="center">&nbsp;</td>
					</tr>
