												...
												<table>
													...
													<tr>
														<td align="left" colspan="3" class="contenu">Le
																nombre de <B>ressources</B> trouvées est supérieur à 100<BR>
													...
													<logic:present name="listeRechercheId">
														...
														<tr>
															<td align="left" colspan="3" class="contenu">Cliquez
																sur un code d'une personne pour la sélectionner</td>
														</tr>
														<BR>
														<tr>
														...
														<%
																...
																if(listeRechercheId.size() == 0)
																{
																	...
																	if(document.forms[0].codeRecherche.value !='')
																		{
																	alert('Ce code ne correspond pas à une ressource existante ou alors cette ressource ne peut pas être sélectionnée');
																	window.close();
																		}
																	
																	if(document.forms[0].nomRecherche.value != '')
																	{
																		alert('Aucune ressource sélectionnable ne correspond à votre demande');
																		window.close();																		
																	}
