...
<input type="hidden" name="jobId" value="<%=sJobId%>">
              ...
              <tr> 
                  <td> 
                    ...
                    <tr>
                        <td colspan=2 align="center"><b>Cet état prend en compte votre périmètre clients, et peut aussi se limiter à certains CADAs</b></td>
                    </tr>
					<tr>
                        <td colspan=2 align="center">&nbsp;</td>
                    </tr>
                    <tr>
	                    <td colspan=1 class="lib" align=left><b>Limitation à des CADAs :</b>
