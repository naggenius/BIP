...
<bip:VerifUser page="jsp/eRefmmoCr.jsp"/>
...
function MessageInitial()
{
	...
	document.editionForm.p_param6.value = "00000";
	}
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						...
						<td><html:text property="p_param6" styleClass="input"  size="5" maxlength="5" onchange="return VerifFormat(this.name);"/></td>
					</tr>
					  <tr>
                        <td colspan=5 align="center">&nbsp;</td>
                      </tr>
