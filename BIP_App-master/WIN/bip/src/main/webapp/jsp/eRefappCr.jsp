...
<bip:VerifUser page="jsp/eRefappCr.jsp"/>
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
                        <td colspan=2><b>Entrez le code DPG du p&ocirc;le dont vous voulez la liste des applications :</b></td>
                      </tr>
					<tr>
