...
function rechercheID(){
	window.open("/recupIdrubrique.do?action=initialiser&nomChampDestinataire=codrub&windowTitle=Recherche Identifiant Code Rubrique&habilitationPage=HabilitationLigneBip"  ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width=650, height=550") ;
	return ;
}  
...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (!ChampObligatoire(form.codrub,"le code Rubrique")) return false;
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des rubriques de facturation interne<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/rubrique"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td align=center><b>Code Rubrique
                    : &nbsp </b></td>
                  <td> 
                     <html:text property="codrub" styleClass="input" size="5" maxlength="5" onchange="return VerifierNum(this,10,0);"/>&nbsp;&nbsp;
