...
function aucuneOptionSelect(){
 if((refChoisi == "DP" && document.forms[0].p_param10.value == '') ||
	(refChoisi == "P" && document.forms[0].p_param9.value == '')){
	return true;
	}
	return false;
}
...
function selectHabil(){
 if(document.forms[0].p_param9.value != '' && (document.forms[0].p_param9.value == '--- Habil Directe ---' || 
	document.forms[0].p_param9.value == '--- Habil par DP ---') ){
	document.forms[0].p_param9.value = ' TOUS';
	return true;
	}
	return false;
}
