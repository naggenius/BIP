...
<bip:VerifUser page="jsp/eSocAd.jsp"/>
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						<td>
						<table><tr>
                        <td align=center class="lib"><B>&nbsp;Liste des soci&eacute;t&eacute;s :&nbsp;</B></td>
                        </tr></table>
                        </td>
						<td align=center>
							<select name="p_param6" class="input" size="3">
                            <option value="A">Actives</option>
                            <option value="F">Ferm&eacute;es</option>
