...
<title>IMPRESSION DES PROFILS PAR DOMAINE FONCTIONNEL: Sélection</title>
<!-- #EndEditable -->
...
{
	<%
		sTitre = com.socgen.bip.metier.Report.getTitre("eProfilsDomFoncAd");
...
function ValiderEcran(form) {
	...
	if (blnVerification==true) {
		...
		{	
			document.forms[0].jobId.value="eProfilsDomFoncHistAd";
		
		}
		else
		{
			document.forms[0].jobId.value="eProfilsDomFoncAd";
		}
		  ...
		  <div align="center"><!-- #BeginEditable "contenu" -->
			...
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  ...
                  <td> 
					<html:text property="p_param6" styleClass="input"  size="3" maxlength="2" value="*" onchange="return isValidCodeDir(); return VerifierAlphaMaxCarSpec(this);"/>
					&nbsp;&nbsp;(* si toutes)
				  </td><td>&nbsp;</td>
                </tr>
                <tr> 
                ...
                <tr><td>&nbsp;</td> 
                  ...
                  <td> 
					<html:text property="p_param7" styleClass="input"  size="8" maxlength="4" onchange="return VerifierFiltreDate(this,'aaaa');" />
					&nbsp;&nbsp; (* pour toutes périodes, ou à compter de AAAA)
				  </td>
                </tr>
                <tr> <td>&nbsp;</td>
                ...
                <tr> <td>&nbsp;</td>
                  ...
                  <td> 
					<html:text property="p_param9" styleClass="input"  size="8" maxlength="7" onchange="return VerifierDateEffet(this,'MM/AAAA');"/>
					&nbsp;&nbsp;(MM/AAAA)
				  </td>
                </tr>                
                <tr> 
