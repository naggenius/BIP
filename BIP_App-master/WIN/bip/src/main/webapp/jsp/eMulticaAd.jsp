...
<bip:VerifUser page="jsp/eMulticaAd.jsp"/>
...
function MessageInitial()
{
	...
	else
	{
		...
		if ((Focus != "" )&& (Focus != "pid"))  (eval( "document.editionForm."+Focus )).focus();
            ...
            <table width="100%" border="0">
                ...
                <tr> 
                  <td> 
					...
					<tr align="left">
						<td width=30>&nbsp;</td>
						<td colspan=2 class="texte">Code ligne BIP :</td>
						<td colspan=4 class="texte"><html:text property="p_param6" styleClass="input"  size="4" maxlength="4" onchange="return VerifierAlphaMax(this);"/>
						&nbsp;&nbsp;<a href="javascript:recherchePID('p_param6');" ><img border=0 src="/images/p_zoom_blue.gif"  alt="Rechercher Code Ligne BIP" title="Rechercher Code Ligne BIP" style="vertical-align : middle;"></a>
                        </td>
					</tr>
					<tr>
					...
					<tr align="left">
						...
						<td colspan=4 class="texte"><html:text property="p_param7" styleClass="input"  size="7" maxlength="7" onchange="return VerifFormat(this.name);"/>
						&nbsp;&nbsp;<a href="javascript:rechercheDPG('p_param7');" ><img border=0 src="/images/p_zoom_blue.gif"  alt="Rechercher Code Ligne BIP" title="Rechercher Code Ligne BIP" style="vertical-align : middle;"></a>
                        </td>
					</tr>
					  <tr>
                        <td colspan=5 align="center">&nbsp;</td>
