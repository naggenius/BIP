                  ...
                  <html:hidden property="keyList0"/> 
                    <table cellspacing="2" cellpadding="2" class="tableBleu">
                      ...
                      <tr align="left"> 
                        ...
                        <td colspan="5" align="center" height="40"class="texte"><u>OU</u></td>
                      </tr>
                      <tr align="left"> 
                      ...
                      <tr align="left"> 
                        <td class="texte"> Identifiant :</td>
																<td colspan="3" class="texte"><html:text
																		property="ident" styleClass="input" size="6"
																		maxlength="5" onchange="return VerifierNum(this,5,0);" />
																	&nbsp;<a href="javascript:rechercheID();"><img
																		border=0 src="/images/p_zoom_blue.gif"
																		alt="Rechercher Identifiant Forfait"
																		title="Rechercher Identifiant Forfait"
