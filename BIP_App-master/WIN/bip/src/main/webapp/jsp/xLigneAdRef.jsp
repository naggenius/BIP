...
<bip:VerifUser page="jsp/xLigneAdRef.jsp"/>
...
{
	<% //ABN - PPM 63555
		if (menuId != null && !menuId.equalsIgnoreCase("REF")) {
			sJobId = "xLigneAd";
		} else {
			sJobId = "xLigneAdRef";
		}
	...
	%>
	//KRA PPM 61346
	//ABN PPM 61346 - QC 1814
	if (document.getElementsByName("p_param9")[0] !== undefined) {
...
function ValiderEcran(form) {
	...
	//ABN PPM 61346 - QC 1814
	if (document.getElementsByName("p_param9")[0] !== undefined) {
		if (!ChampObligatoire(form.p_param9, "un code DPG")) {
			return false;
		}
	}
	//Fin KRA PPM 61346
