...
<bip:VerifUser page="jsp/eCtrfinOr.jsp"/>
...
function ValiderEcran(form)
{
   if (blnVerification) {
        ...
        if (!ChampObligatoire(form.p_param6, "une date de fin")) return false;
        if (!ChampObligatoire(form.p_param8, "le code DPG")) return false;
   }
   //document.editionForm.p_param8.value = Replace_DoubleEtoile_by_DoubleZero(document.editionForm.p_param8.value);
...
<input type="hidden" name="jobId" value="<%=sJobId%>">
			<input type="hidden" name="p_param7" value="ACH">
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						<td class="lib"><b>Date de fin des contrats :</b></td>
