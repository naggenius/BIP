...
<jsp:useBean id="RecupCodeComptaForm" scope="request" class="com.socgen.bip.form.RecupCodeComptaForm" />
...
function MessageInitial() {
   ...
   var Message="<bean:write filter="false"  name="RecupCodeComptaForm"  property="msgErreur" />";
   var Focus = "<bean:write name="RecupCodeComptaForm"  property="focus" />";
   if (Message != "") {
      alert(Message);
   }
...
function fill(num) {
	var cible = "<%=RecupCodeComptaForm.nomChampDestinataire%>";
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><bean:write name="RecupCodeComptaForm" property="windowTitle" /></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        ...
        <BR>
        <tr> 
          <td><html:form action="/recupCodeCompta.do">
...
<html:hidden property="action" value="modifier"/>
                     ...
                     <html:hidden name="RecupCodeComptaForm" property="nomChampDestinataire"/>
                     <html:hidden name="RecupCodeComptaForm" property="windowTitle"/>
                     <html:hidden name="RecupCodeComptaForm" property="habilitationPage"/>  
...
-->
         				...
         				<table width=80%>            	
							...
							<% if  	(listeRechercheId.size()>0){%>
								<tr>
									<td colspan ="4" class="contenu">Cliquez sur un code comptabilit&eacute; pour le s&eacute;lectionner</td>
								</tr>
								<BR>
 								<tr>
					 				<td class="lib" width="25%" >Code Comptable</td>
								...
								<logic:iterate id="element"  name="listeRechercheId"  length="<%=listeRechercheId.getCountInBlock()%>" 
									...
									type="com.socgen.bip.metier.InfosCodeCompta"
									indexId="index"> 
									<% if ( i == 0) i = 1; else i = 0;%>
