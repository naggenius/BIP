...
<form action="xLigneAd.jsp?addFav=yes&typFav=X&pageAide=<%= sPageAide %>" method="post">
<input type="hidden" name="arborescence" value="<%= arborescence %>">
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
<input type="hidden" name="initial" value="<%= sInitial %>">
<input type="hidden" name=titlePage value="Ligne BIP">
<input type="hidden" name=lienFav value="/jsp/xRedirectLigne.jsp">

</form>

<form action="xLigneBip.jsp?addFav=yes&typFav=X&pageAide=<%= sPageAide %>" method="post">
<input type="hidden" name="arborescence" value="<%= arborescence %>">
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
<input type="hidden" name="initial" value="<%= sInitial %>">
<input type="hidden" name=titlePage value="Lignes BIP">
<input type="hidden" name=lienFav value="/jsp/xRedirectLigne.jsp">
</form>
</body>
</html:html>
