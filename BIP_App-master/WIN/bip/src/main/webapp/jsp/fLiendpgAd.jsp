...
function ValiderEcran(form)
{
  if (blnVerification==true) {
     if (form.action.value!="valider")
  		form.action.value ="suite";
     if (!ChampObligatoire(form.codsg, "un code Département/Pôle/Groupe")) return false;
  }
...
function rechercheDPG(champs)
{
	window.open("/recupDPG.do?action=initialiser&nomChampDestinataire="+champs+"&windowTitle=Recherche Code DPG&habilitationPage=HabilitationLigneBip"  ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width=450, height=450") ;
	return ;
}
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
            <html:hidden property="table" value="DPG"/>
              <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td  class="lib" align=center  ><b>Code D&eacute;partement/P&ocirc;le/Groupe :</b></td>
                  <td><html:text property="codsg" styleClass="input" size="8" maxlength="7" onchange="return VerifierNum(this,7,0);"/>
                  &nbsp;&nbsp;<a href="javascript:rechercheDPG('codsg');" ><img border=0 src="/images/p_zoom_blue.gif"  alt="Rechercher Code Ligne BIP" title="Rechercher Code Ligne BIP" align="absbottom"></a>
                  </td>
                </tr>
                <tr> 
                  <td align=center colspan=2>&nbsp;</td>
