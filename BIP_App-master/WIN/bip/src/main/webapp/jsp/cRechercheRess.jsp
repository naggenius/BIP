...
<%
	...
	if(Rtype.equals("A"))
	   sRtype = " Creer un agent SG : Données Urbann";
	else if(Rtype.equals("P"))
	   sRtype = " Creer une prestation : Données Urbann "; 
...
<html:form action="/personne"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable --> 
	...
	<html:hidden property="etape"/>
			...
			<table cellspacing="2" cellpadding="2" class="tableBleu" border="0" width="50%" align="center">
				...
				<tr align="center">
					<td class="lib"><b>
					<span STYLE="position: relative; z-index: 1; right : 177px ">Civilité</span>
					<span STYLE="position: relative; z-index: 1; right : 169px">Nom</span>	
					<span STYLE="position: relative; z-index: 1; left : 22px">Prénom</span>
...
<%} else {%>
			<table cellspacing="2" cellpadding="2" class="tableBleu" border="0" width="50%" align="center">
				<tr><td align="center">Aucun résultat</td></tr>
			</table>
<%} %>
			</br>
			</br>
			<table width="100%" border="0">
                ...
                <tr> 
				  ...
				  <td width="20%" align="center"> 
     			  <html:submit property="boutonModifier" value="Sélectionner" styleClass="input" onclick="Verifier(this.form, 'suite1', 'insert', true, '');"/>
                  </td>
                  <%} %>
				  <td width="20%" align="center">  
                  ...
                  <td width="20%" align="center">  
				  <html:submit property="boutonCreer" value="Cr&#233er à vide" styleClass="input" onclick="Verifier(this.form, 'suite1', 'insert' ,true, 'vide');"/>
                  </td>
                  <td width=10%>&nbsp;</td>
