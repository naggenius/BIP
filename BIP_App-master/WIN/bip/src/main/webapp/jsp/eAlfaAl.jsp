...
<bip:VerifUser page="jsp/eAlfaAl.jsp"/>
...
function MessageInitial()
{
	...
	tabVerif["p_param6"] = "VerifierAlphanum(document.editionForm.p_param6)";
...
function ValiderEcran(form)
{
	if (blnVerification)
	{
		...
		if (!ChampObligatoire(form.p_param6,"le nom ou les premières lettres du libellé")) return false;
	}
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						<td colspan=2 class="lib"><B>Nom ou premi&egrave;res lettres du libell&eacute; :</B></td>
                      </tr>
					<tr>
						<td colspan=2><html:text property="p_param6" styleClass="input"  size="50" maxlength="50" onchange="return VerifFormat(this.name);"/></td>
					</tr>

					<tr>
						<td colspan=2>Renvoie les éléments dont le libellé <B>commence</B> par les caractères saisis</td>
                      </tr>
