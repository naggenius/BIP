                ...
                <tr> 
                  <td> 
					...
					<input type="hidden" name="menu" value="<%= menuId %>">
                      ...
                      <tr align="left">
						<td class="texte" colspan=1><input type=radio name="listeReports" value="1">Ressources cr&eacute;&eacute;es</td>
						<td class="texte" colspan=2><input type=radio name="listeReports" value="2">Rejets</td>
					 </tr>
					 <tr>
						<td colspan=3 align="center">&nbsp;</td>
					</tr>
					<tr align="left">
						<td colspan=3 align="center" class="texte">NB : les ressources cr&eacute;&eacute;es et les rejets sont conserv&eacute;s 2 mois</td>
					</tr>
					<tr>
