...
String sPageAide = ESAPI.encoder().encodeForJavaScript(ESAPI.encoder().canonicalize(request.getParameter("pageAide")));
	...
	java.util.Vector vLignes = com.socgen.bip.rbip.intra.RBipFichier.getLignesFichier(rBipDisplayAdminForm.getPID(), rBipDisplayAdminForm.getIDRemonteur(),rBipDisplayAdminForm.getFichier());
...
<tr>
	<td class="lib" align="center"><b> Lignes du fichier <bean:write name="rBipDisplayAdminForm"  property="fichier" /> de <bean:write name="rBipDisplayAdminForm"  property="IDRemonteur" /> </b></td>
</tr>
<tr>
	<td  width="500">
