...
<bip:VerifUser page="jsp/eLogsDossProjAd.jsp"/>
...
{
   if (blnVerification) {
        if (!ChampObligatoire(form.p_param6, "un code dossier projet")) return false;
   }
					...
					<table border=0 cellspacing=2 cellpadding=2 class="tableBleu">
					  ...
					  <tr>
                        ...
                        <td> 
					        ...
					        <a href="javascript:rechercheDP();"><img border=0 src="/images/p_zoom_blue.gif" alt="Rechercher Code Projet" title="Rechercher Code Projet" align="absbottom"></a>
                        </td>
					  </tr>
		   		    </table>
					</div>
