...
<%
  java.util.ArrayList list1 = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("descr_type2",type2Form.getHParams()); 
  pageContext.setAttribute("choixType2", list1);
%>
...
{
   var index = form.arctype.selectedIndex;
   if (blnVerification==true) {
	if ( (index==-1) && (form.action.value != 'creer') ) {
         alert("Choisissez un type secondaire");
	   return false;
	}
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour de la Typologie secondaire<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/type2"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
              <table cellspacing="2" cellpadding="2" class="tableBleu"   >
                ...
                <tr> 
                  <td    class="lib" colspan=2 align=center><b>Type 2</b></td>
                </tr>
                <tr> 
                  <td  colspan="2" align="center">
                  	<html:select property="arctype" styleClass="input" size="10"> 
   						<html:options collection="choixType2" property="cle" labelProperty="libelle" />
					</html:select>
				  </td>
				</tr>
                <tr> 
