...
<bip:VerifUser page="jsp/eEditionRe.jsp"/>
...
function MessageInitial()
{
	...
	{
		document.editionForm.p_param6.value = "<bean:write name="UserBip" property="dpg_Defaut" />";
		if (Focus != "")
		{ 
                ...
                <tr> 
                  <td> 
					...
					<tr>
						...
						<td><html:text property="p_param6" styleClass="input"  size="7" maxlength="7" onchange="return VerifierNum(this,7,0);"/></td>
					</tr>
					  <tr>
                        <td colspan=5 align="center">&nbsp;</td>
                      </tr>
