...
String sTitre;
	String sInitial;
	String sJobId="eDetailReestimeRe";
	String codsg;
...
function ValiderEcran(form)
{
	...
	document.syntheseLocaleForm.boutonValider.disabled = true;
	return true;
}
...
function ChangeDpg(codsg)
{
    ...
    if(VerifierRegExp(codsg,'[0-9]{7}','Saisie invalide - Attention le code DPG est sur 7 chiffres'))
    {
	      document.forms[0].submit();
	      return true;
	}
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td> 
          	<html:form action="/detailReestime"  onsubmit="return ValiderEcran(this);">
...
<input type="hidden" name="jobId" value="<%=sJobId%>">
            ...
            <table width="100%" border="0">
                ...
                <tr>
                	<td class="lib"><B>Groupement : </B></td>
                    <td align=left>
                    	<input type="radio" name="p_param9" value="R" class="input" checked="checked"> par ressource
					</td>
                </tr>
                <tr>
                	<td >&nbsp;</td>
                    <td align=left>
                    	<html:radio property="p_param9" styleClass="input" value="A" /> par activit&eacute;
					</td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
