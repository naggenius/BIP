      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Rattachement 
            en masse des lignes BIP - CP<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
                    <html:hidden property="mode" value="CP"/>
            		<html:hidden property="table" value="CP"/>
                      ...
                      <tr> 
                        <td align=center><b>Le chef de projet : </b></td>
                        <td align=center><b><bean:write name="lienLigneForm"  property="cpcode" /> - <bean:write name="lienLigneForm"  property="rnom" /> <bean:write name="lienLigneForm"  property="rprenom" /> </b>
                   			 <html:hidden property="cpcode"/>
                      ...
                      <tr> 
                        ...
                        <td class="lib"><b> Libell&eacute; ligne BIP </b></td>
                      </tr>
                      <tr> 
