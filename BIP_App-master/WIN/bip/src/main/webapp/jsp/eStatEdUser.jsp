...
<bip:VerifUser page="jsp/eStatEdUser.jsp"/>
...
function MessageInitial()
{
	...
	{
		document.editionForm.p_param8.value = "<bean:write name="UserBip" property="idUser" />";
		if (Focus != "")
		{ 
...
{
   if (blnVerification) {
        if (!ChampObligatoire(form.p_param8, "USER")) return false;
   }
                ...
                <tr> 
                  ...
                  <tr> 
 					...
 					<tr>
						...
						<td>
							<html:text property="p_param8" styleClass="input"  size="7" maxlength="7" />
						</td>
					</tr>
					<tr> 
						<td class="lib"><B>Date de d&eacute;but de suivi (jj/mm/aaaa) : </B></td>
						<td><html:text property="p_param6" styleClass="input"  size="10" maxlength="10" onchange="return VerifierDate(this,'jj/mm/aaaa');"/></td>
                    </tr>
					<tr>
						<td class="lib"><B>Date de fin de suivi (jj/mm/aaaa) : </B></td>
