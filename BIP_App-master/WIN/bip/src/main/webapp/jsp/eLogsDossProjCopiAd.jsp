...
<bip:VerifUser page="jsp/eLogsDossProjCopiAd.jsp"/>
...
<%
	String sTitre;
	String sInitial;
	String sJobId="eLogsDossProjCopiAd";
%>
...
{
   if (blnVerification) {
        if (!ChampObligatoire(form.p_param6, "un code dossier projet copi")) return false;
   }
                ...
                <tr> 
                  <td> 
					...
					<table border=0 cellspacing=2 cellpadding=2 class="tableBleu">
					  ...
					  <tr>
                        <td align="center"><b>Code dossier projet copi :</b></td>
                        <td> 
                  	        <html:text property="p_param6" styleClass="input" size="6" maxlength="6" onchange="this.value = this.value.toUpperCase();return VerifierAlphaMax(this);"/>&nbsp;
					        </td>
					  </tr>
		   		    </table>
					</div>
