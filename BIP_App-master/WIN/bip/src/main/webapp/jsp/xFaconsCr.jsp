...
<bip:VerifUser page="jsp/xFaconsCr.jsp"/>
...
function ValiderEcran(form) {
	...
	if (form.listeReports[0].checked==true) {
		form.p_param7.value="N";
	
	}
	else {
		form.p_param7.value="N1";
            ...
            <table width="100%" border="0">
                <tr> 
                  <td> 
					...
					<tr>
						<td colspan=1 class="lib"><input type=radio name="listeReports" value="1" checked>Année courante</td>
						<td colspan=1 class="lib"><input type=radio name="listeReports" value="2">Année précédente</td>
                    </tr>
			   		</table>
