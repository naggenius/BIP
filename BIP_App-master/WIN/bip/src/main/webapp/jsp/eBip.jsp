...
<bip:VerifUser page="jsp/eBip.jsp"/>
...
function ValiderEcran(form)
{
	if (blnVerification)
	{
		...
		if (!ChampObligatoire(form.p_param6, "un code ligne BIP")) return false;
	}
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						...
						&nbsp;&nbsp;<a href="javascript:recherchePID('p_param6');" ><img border=0 src="/images/p_zoom_blue.gif"  alt="Rechercher Code Ligne BIP" title="Rechercher Code Ligne BIP" align="absbottom"></a>
                       </td>
					</tr>
					<tr><td colspan=5 align=center>&nbsp;</td></tr><tr>
					<!-- #EndEditable -->
