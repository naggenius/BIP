...
<bip:VerifUser page="jsp/xResHist.jsp"/>
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						...
						<td><html:text property="p_param6" styleClass="input"  size="7" maxlength="7" onchange="return VerifierCDDPG(this);"/>
