...
<!-- #EndEditable -->  <!-- #BeginTemplate "/Templates/Page_filtre.dwt" --><head>
...
function MessageInitial()
{
   ...
   tabVerif["couann"]  = "VerifierDate(document.forms[0].couann,'aaaa')";
   if (Message != "") {
      alert(Message);
   }
  if (Focus != "") (eval( "document.forms[0]."+Focus )).focus();
   else {
	  document.forms[0].couann.focus();
   }
}
...
{	
   form.keyList0.value = form.couann.value;
   if (blnVerification==true) {
    if ( !VerifFormat(null) ) return false;
	if (!ChampObligatoire(form.couann, "une année")) return false;
   }
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des Coûts standards<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/standard"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="suite"/>
		    ...
		    <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                  ...
                  <td align="center" > <b> Année du coût standard :</b></td> 
                   <td> 
                   <html:text property="couann" styleClass="input" size="5" maxlength="4" onchange="return VerifFormat(this.name);"/>
