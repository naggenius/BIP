...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (form.codsg && !ChampObligatoire(form.codsg,"le code DPG")) return false;
...
function rechercheDPG(){
	window.open("/recupDPG.do?action=initialiser&nomChampDestinataire=codsg&windowTitle=Recherche Code DPG Fournisseur&habilitationPage=HabilitationLigneBip"  ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width=450, height=450") ;
	return ;
}
function nextFocusDPG(){		document.forms[0].boutonCreer.focus();}
</script>
<!-- #EndEditable -->  
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des DPG<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="action" value="creer"/>
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td align=center><b>Code Département/Pôle/Groupe 
                    : &nbsp </b></td>
                  <td> 
                     <html:text property="codsg" styleClass="input" size="8" maxlength="7" onchange="return VerifierNum(this,7,0);"/>
