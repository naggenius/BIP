...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (!ChampObligatoire(form.dpCopi, "un code dossier projet COPI")) return false;
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Notation d'un Dossier projet COPI<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/notationDpcopi"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>
		       <table width="100%" border="0" cellpadding=2 cellspacing=2 class="tableBleu">
                      ...
                      <tr> 
                       ...
                       <html:text property="dpCopi" styleClass="input" size="6" maxlength="6" onchange="this.value = this.value.toUpperCase();return VerifierAlphaMax(this);"/>&nbsp;&nbsp;
