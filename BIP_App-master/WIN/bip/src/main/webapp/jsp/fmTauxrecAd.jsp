...
function MessageInitial()
{
   ...
   var Focus = "<bean:write name="tauxrecForm"  property="focus" />";
   if (Message != "") {
      alert(Message);
   }
...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	...
	if (!ChampObligatoire(form.annee, "l'année")) return false;
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise à jour des Taux annuels<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/tauxrec"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>
              <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  ...
                  <td> 
                  <html:text property="annee" styleClass="input" size="5" maxlength="4" onchange="return VerifierNum(this,4,0);"/>
                  </td>
                </tr>
                <tr> 
                  <td align=center  ><b>Filiale :</b></td>
                  <td> 
