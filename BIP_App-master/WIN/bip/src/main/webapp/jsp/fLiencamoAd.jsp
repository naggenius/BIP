...
function ValiderEcran(form)
{
  if (blnVerification==true) {
     if (form.action.value!="valider")
  		form.action.value ="suite";
     if (!ChampObligatoire(form.codcamo, "un code centre d'activité")) return false;
  }
            ...
            <html:hidden property="table" value="CAMO"/>
              <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  ...
                  <td><html:text property="codcamo" styleClass="input" size="6" maxlength="6" onchange="return VerifierNum(this,6,0);"/>
