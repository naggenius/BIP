...
<bip:VerifUser page="jsp/eResdpgOr.jsp"/>
...
function MessageInitial()
{
	...
	tabVerif["p_param6"] = "VerifierCDDPG(document.editionForm.p_param6)";
...
<input type="hidden" name="jobId" value="<%=sJobId%>">
			<input type="hidden" name="p_param7" value="<bean:write name="UserBip"  property="centre_Frais" />">
			<input type="hidden" name="p_param8" value="ACHMENU" >
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
                        <td colspan=2><b>Entrez le code DPG du p&ocirc;le dont vous voulez la liste des ressources :</b></td>
                      </tr>
					<tr>
