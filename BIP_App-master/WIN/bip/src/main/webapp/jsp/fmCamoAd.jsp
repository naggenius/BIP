...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (!ChampObligatoire(form.codcamo, "un code centre d'activité MO")) return false;
...
function rechercheID(){
	window.open("/recupIdCa.do?action=initialiser&nomChampDestinataire=codcamo&windowTitle=Recherche Identifiant Centre d'Activités&habilitationPage=HabilitationLigneBip"  ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width=450, height=450") ;
	return ;
}  
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise à jour des Centres d'activités MO<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="action" value="creer"/>
		       <table width="100%" border="0" cellpadding=2 cellspacing=2 class="tableBleu">
                      ...
                      <tr> 
                        <td align="center"><b>Code centre d'activité MO </b> : 
                       <html:text property="codcamo" styleClass="input" size="7" maxlength="6" onchange="return VerifierNum(this,6,0);"/>&nbsp;&nbsp;
