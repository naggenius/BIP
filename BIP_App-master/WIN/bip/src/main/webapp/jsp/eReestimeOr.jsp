...
<jsp:useBean id="editionReForm" scope="request" class="com.socgen.bip.form.EditionReForm" />
...
<bip:VerifUser page="jsp/eReestimeOr.jsp"/>
...
<%
	...
	if(editionReForm.getP_param6() != null)
	{
		
		codsg = editionReForm.getP_param6();
		if(codsg.equals(""))  
		{
		...
		{     
	    	...
	    	hKeyList.put("codsg", ""+editionReForm.getP_param6());
		    hKeyList.put("userid", ""+((com.socgen.bip.user.UserBip)session.getAttribute("UserBip")).getInfosUser());
		
		  		
		   if(editionReForm.getP_param6().charAt(editionReForm.getP_param6().length()-1) != '*' )
		   {
			try{
...
function MessageInitial()
{
	...
	%>
	var Message="<bean:write filter="false"  name="editionReForm"  property="msgErreur" />";
	var Focus = "<bean:write name="editionReForm"  property="focus" />";
	...
	{
		var p_param6Form = "<bean:write name="editionReForm"  property="p_param6" />";
		if(p_param6Form == "")
		{
    ...
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr> 
        ...
        <tr> 
          <td>
		  <html:form action="/editionRe"  onsubmit="return ValiderEcran(this);">
