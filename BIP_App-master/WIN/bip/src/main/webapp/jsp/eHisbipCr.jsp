...
<bip:VerifUser page="jsp/eHisbipCr.jsp"/>
...
function ValiderEcran(form)
{
	if (blnVerification) {
		...
		if (!ChampObligatoire(form.p_param8, "un code de ligne BIP")) return false;
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						...
						<td><html:text property="p_param8" styleClass="input"  size="4" maxlength="4" onchange="return VerifFormat(this.name);"/></td>
					</tr>
