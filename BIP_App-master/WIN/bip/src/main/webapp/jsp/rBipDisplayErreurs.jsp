...
String sPageAide = ESAPI.encoder().encodeForJavaScript(ESAPI.encoder().canonicalize(request.getParameter("pageAide")));
	...
	java.util.Vector vLignes = com.socgen.bip.rbip.intra.RBipFichier.getErreursFichier(request.getParameter("PID"), userBip.getIdUser(),request.getParameter("fichier"));
%>
...
<tr>
	<td align="center" colspan="3"><b> Erreurs du Fichier <bean:write name="rBipDisplayForm"  property="fichier" /> </b></td>
</tr>
<tr>
