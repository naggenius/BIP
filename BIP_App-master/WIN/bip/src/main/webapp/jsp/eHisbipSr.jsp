...
<bip:VerifUser page="jsp/eHisbipSr.jsp"/>
<%
	...
	java.util.ArrayList listIsacPid = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("isac_pid", hP); 
	pageContext.setAttribute("choixIsacPid", listIsacPid);
%>
