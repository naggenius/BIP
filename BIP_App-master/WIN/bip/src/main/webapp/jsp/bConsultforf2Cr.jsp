...
<bip:VerifUser page="jsp/bConsultforfCr.jsp"/>

<%
	java.util.ArrayList list1 = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("situpers",forfaitForm.getHParams()); 
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td> <!-- #BeginEditable "debut_form" --><html:form action="/consultForf"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable --> 
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
                ...
                <tr> 
                  ...
                  <td ><b><bean:write name="forfaitForm"  property="rnom" /></b>
                    	<html:hidden property="rnom"/> 
                  </td>
                  <td colspan=2>&nbsp;</td>
                  <td class="lib" colspan="4"> Coût standard :</td>
                  <td colspan="2">
                  		<bean:write name="forfaitForm"  property="coufor" />
                ...
                <tr> 
                  ...
                  <td ><bean:write name="forfaitForm"  property="ident" />
                ...
                <tr>
                <td align="center"> <a href="/consultForf.do?action=annuler"> 
