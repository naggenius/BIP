...
function ValiderEcran(form)
{
   ...
   if (blnVerification) { 
	  	...
	  	if (form.mode.value == 'delete') { 
			   ...
			   if ( !ChampObligatoirePersonnalise(document.forms[0].codePourSupprimer ,"Veuillez sélectionner une Enveloppe Budgétaire !")) { 
				 	return false;
				} 
				else{
					if (!confirm("Voulez-vous supprimer cette Enveloppe Budgétaire ?")) 
					return false;
				} 		
		}
   }
...
function modifieAxeStrategique(){
	   ...
	   if ( !ChampObligatoirePersonnalise(document.forms[0].codePourSupprimer ,"Veuillez sélectionner une Enveloppe Budgétaire !")) { 
			...
			window.open("/modifieLoupeAction.do?action=initialiser&updateProcedure=copi.axestrategique.modifier.proc&libelle="+libelleAmodifier+"&code="+ codeAxeStrategiqueModif +"&windowTitle=Modification Enveloppe Budgétaire&habilitationPage=HabilitationLigneBip"  ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=no, scrollbars=no, width=500, height=200") ;
			return ;
		} 		
    ...
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          ...
          <bean:write name="listeNotificationCopiForm" property="titrePage"/>Créer / Modifier / supprimer une Enveloppe Budgétaire<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
              ...
              <table cellspacing="2" cellpadding="2" class="tableBleu"  >
                ...
                <tr> 
                 <td align="center" width="100%" colspan="4">
                    ...
                    <table align="center">
                      <tr>
                          <td class="lib" align="center" width="35%"><b>Enveloppes Budgétaires existantes :</b></td>
                          <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      ...
                      <tr>
            			<td width="100%" colspan="4" class="contenu">Pour supprimer ou modifier une Enveloppe Budgétaire , veuillez d'abord la selectionner dans la liste et cliquer ensuite sur le bouton correspondant</td>           
          	   		  </tr>   
                      ...
                      <tr>
                        <td class="lib"><b>Saisir Enveloppe Budgétaire :</b></td>
                      	<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      	 <td>
