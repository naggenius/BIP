...
function ValiderEcran(form)
{
	...
	if (!ChampObligatoire(form.ident, "l'identifiant d'une personne")) return false;
...
<html:hidden property="action" value="suite"/>
                  ...
                  <html:hidden property="rnom"/>  <!-- variable d'entrée utilisée dans la procédure -->
				  <html:hidden property="codsg"/>   <!-- variable d'entrée utilisée dans la procédure -->
				  <html:hidden property="prestation"/>   <!-- variable d'entrée utilisée dans la procédure -->
