...
<bip:VerifUser page="jsp/fLienappliAd.jsp"/> 
...
function MessageInitial()
{
   ...
   tabVerif["airt"]  = "VerifierAlphaMax(document.forms[0].airt)";
   if (Message != "") {
      alert(Message);
   }
...
function ValiderEcran(form)
{
  if (blnVerification==true) {
     ...
     if (!ChampObligatoire(form.airt, "un code application")) return false;
  }
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td> <!-- #BeginEditable "debut_form" --><html:form action="/lienAppli"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable --> 
            ...
            <html:hidden property="table" value="APP"/>
              <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  ...
                  <td><html:text property="airt" styleClass="input" size="5" maxlength="5" onchange="return VerifierAlphaMax(this);"/>
                  <a href="javascript:rechercheAppli();"  onFocus="javascript:nextFocusAppli();"><img border=0 src="/images/p_zoom_blue.gif"  alt="Rechercher Code Application" title="Rechercher Code Application" align="absbottom"></a>
                   </td>
                <tr> 
                  <td align=center colspan=2>&nbsp;</td>
                </tr>
