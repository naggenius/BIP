...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (!ChampObligatoire(form.code_four_copi,"le code fournisseur")) return false;
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des Fournisseurs COPI<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/FourCopi"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td align=center><b>Code Fournisseur
                    : &nbsp </b></td>
                  <td> 
                     <html:text property="code_four_copi" styleClass="input" size="2" maxlength="2" onchange="return VerifierNum(this,2,0);"/>&nbsp;&nbsp;
