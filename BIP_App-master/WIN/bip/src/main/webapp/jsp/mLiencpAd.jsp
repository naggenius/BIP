      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" --> 
           Liens lignes BIP  - CP<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
              <table border=0 cellspacing=2  cellpadding=2  class="tableBleu" >
                ...
                <tr> 
                  ...
                  <td><b><bean:write name="lienLigneForm"  property="cpcode" /> - <bean:write name="lienLigneForm"  property="rnom" /> <bean:write name="lienLigneForm"  property="rprenom" /></b>
...
<% 
Integer id_webo_page = new Integer("1046"); 
