                ...
                <tr> 
                  <td> 
					...
					<table border=0 cellspacing=5 cellpadding=0 class="tableBleu">
						...
						<tr>
                  			<td class=lib>
                  				<b>Date d'enregistrement comptable supérieure à :</b>
                  			</td>
                  			<td>
						...
						<tr>
                  			<td class=lib>
                  				<b>Date d'enregistrement comptable inférieure à :</b>
                  			</td>
                  			<td>
						...
						<tr>
                  			<td class=lib>
                  				<b>Date de prestation supérieure à :</b>
                  			</td>
                  			<td>
						...
						<tr>
                  			<td class=lib>
                  				<b>Date de prestation inférieure à :</b>
                  			</td>
                  			<td>
