...
<bip:VerifUser page="jsp/eLogsPrestationAd.jsp"/>
...
<%
	String sTitre;
	String sInitial;
	String sJobId="eLogsPrestationAd";
%>
...
{
   if (blnVerification) {
        if (!ChampObligatoire(form.p_param6, "une prestation")) return false;
   }
                ...
                <tr> 
                  <td> 
					...
					<table border=0 cellspacing=2 cellpadding=2 class="tableBleu">
					  ...
					  <tr>
                        <td align="center"><b>Prestation :</b></td>
                        <td> 
                  	        <html:text property="p_param6" styleClass="input" size="3" maxlength="3" onchange="this.value = this.value.toUpperCase();return VerifierAlphaMax(this);"/>&nbsp;
					        </td>
					  </tr>
		   		    </table>
					</div>
