...
<html:hidden property="action" value="modifier"/>
         ...
         <table>            	
            ...
            <tr><td colspan="3" class="contenu"><B>Le nombre de personnes trouvées est supérieur à 100<BR>
...
<tr><td colspan ="4" class="contenu">Cliquez sur un code d'une personne pour la sélectionner</td></tr>
<BR>
 <tr>
