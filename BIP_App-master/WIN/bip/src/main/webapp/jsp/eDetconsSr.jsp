...
<bip:VerifUser page="jsp/eDetconsSr.jsp"/>
<%
	...
	java.util.ArrayList listRessource = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("isac_resscons", hP); 
	pageContext.setAttribute("choixRessource", listRessource);
%>
...
function MessageInitial()
{
	...
	document.editionForm.p_param6.options[document.editionForm.p_param6.length] = new Option("Tous", "Toute", true, true);
	document.editionForm.p_param6.selectedIndex=parseInt(document.editionForm.p_param6.length)-1;
}
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						<td class="lib"><b>Choisissez une ressource : </b></td>
						<td>
