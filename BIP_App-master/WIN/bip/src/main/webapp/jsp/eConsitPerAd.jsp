...
String sPageAide = ESAPI.encoder().encodeForJavaScript(ESAPI.encoder().canonicalize(request.getParameter("pageAide")));
	String sIdent = ESAPI.encoder().encodeForJavaScript(ESAPI.encoder().canonicalize(request.getParameter("ident")));
...
var soccode = "<bean:write name="personneForm"  property="soccode" />";
...
var Message1 = "<bean:write name="editionForm"  property="msgErreur" />";
	...
	if (Message1 != "") {
		...
		if("<%= sSoccode %>"=="SG..")				
		     document.location.href="/jsp/bPersonneAd.jsp?ident=<%= sIdent %>&rtype=A&soccode=SG..";
		else			
		     document.location.href="/jsp/bPersonneAd.jsp?ident=<%= sIdent %>&rtype=P";     
        ...
        <tr> 
          <td>
            ...
            <input type="hidden" name="jobId" value="<%=sJobId%>">
                ...
                <input type="hidden" name="ident" value="<%= sIdent %>">
...
<!-- LANCEMENT DE L'EDITION SANS CLIQUER SUR LE BOUTON -->
	<script language="JavaScript">
		document.forms[0].p_param6.value=ident;
