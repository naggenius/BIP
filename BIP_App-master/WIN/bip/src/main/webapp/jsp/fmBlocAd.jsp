...
java.util.ArrayList list1 = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("bloc_npsi",hP); 
pageContext.setAttribute("choixBloc", list1);
%>
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage">Tables - Mise &agrave; jour Bloc</td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
              <table cellspacing="2" cellpadding="2" class="tableBleu"   >
                ...
                <tr> 
                  <td    class="lib" colspan=2 align=center><b>Blocs</b></td>
                </tr>
                <tr> 
