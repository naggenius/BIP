...
<title>Edition des paramètres Bip</title>
<!-- #EndEditable -->
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<!-- #BeginEditable "fichier" --> 
<bip:VerifUser page="jsp/eParamBipAd.jsp"/> 
...
{
	<%
		sTitre = com.socgen.bip.metier.Report.getTitre("eParamBipAd");
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
		  ...
		  <div align="center"><!-- #BeginEditable "contenu" -->
            <input type="hidden" name="jobId" value="eParamBipAd">
			...
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td class="lib">Codes action&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;de :&nbsp;</td>
                  <td> 
					<html:text property="p_param6" styleClass="input"  size="27" maxlength="25"/>
					&nbsp;&nbsp;(laisser vide pour sélectionner le premier)
				  </td>
                </tr>
                <tr> 
                  <td class="lib" align="right">à :&nbsp;&nbsp;&nbsp;</td>
                  <td> 
					<html:text property="p_param7" styleClass="input"  size="27" maxlength="25"/>
					&nbsp;&nbsp;(laisser vide pour sélectionner le dernier)
				  </td>
                </tr>
                <tr> 
                  <td class="lib">Lignes : </td>
                  <td> 
					<input type="radio" name="p_param8" value="TOUTES" checked />&nbsp; Toutes
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="p_param8" value="ACTIVES" />&nbsp; Actives
				  </td>
                </tr>
                <tr> 
                  <td colspan="2">&nbsp;</td>
