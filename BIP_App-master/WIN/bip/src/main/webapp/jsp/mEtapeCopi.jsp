...
function ValiderEcran(form)
{
   ...
   if (blnVerification) { 
	  	...
	  	if (form.mode.value == 'delete') { 
			   ...
			   if ( !ChampObligatoirePersonnalise(document.forms[0].codePourSupprimer ,"Veuillez sélectionner une Etape !")) { 
				 	return false;
				} 
				else{
    ...
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          ...
          <bean:write name="listeNotificationCopiForm" property="titrePage"/>Créer / Modifier / supprimer une Etape<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
