...
<bip:VerifUser page="jsp/eTypeEtapeAd.jsp"/> 
...
{
	<%
		sTitre = com.socgen.bip.metier.Report.getTitre("eTypeEtapeAd");
...
function ValiderEcran(form) {
	...
	if (!ChampObligatoire(form.p_param6, "au minimum 1 car.")) return false;
	return true;
}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
		  ...
		  <div align="center"><!-- #BeginEditable "contenu" -->
            <input type="hidden" name="jobId" value="eTypeEtapeAd">
			...
			<table border=0 cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td class="lib"><b>Jeu de types d'étapes : </b></td>
                  <td> 
					<html:text property="p_param6" styleClass="input"  size="12" maxlength="12" onchange="return  VerifierAlphaMax(this);"/>
				  </td>
				  <td >&nbsp;</td>
				  <td>Saisir au moins 1 car.</td>
                </tr>
                <tr> 
                  <td colspan="3">&nbsp;</td>
                  <td>ou * si tous les jeux</td>
                </tr>
                <tr> 
                  <td colspan="4">&nbsp;</td>
                </tr>
                 <tr> 
                  <td colspan="4" align="center"><i>L'état sera lancé immédiatement</i></td>
                 </tr>
				<tr> 
                  <td colspan="4">&nbsp;</td>
                </tr>
