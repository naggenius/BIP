...
function MessageInitial()
{
   ...
   tabVerif["calanmois"]  = "VerifierDate2(document.forms[0].calanmois,'mmaaaa')";
   ...
   if (Focus != "") (eval( "document.forms[0]."+Focus )).focus();
	  ...
	  document.forms[0].calanmois.focus();
   }
}
...
function ValiderEcran(form)
{
   ...
   if (form.action.value!="valider")
  		form.action.value ="modifier";
	if (!ChampObligatoire(form.calanmois, "un mois/année")) return false;
   }
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise à jour du calendrier<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="action" value="modifier"/>
            ...
            <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td align=center  ><b>Mois / Ann&eacute;e :&nbsp;</b></td>
                  <td><html:text property="calanmois" styleClass="input" size="7" maxlength="7" onchange="return VerifFormat(this.name);"/>
                  </td>
                </tr>
                <tr> 
                  <td align=center colspan=2>&nbsp;</td>
