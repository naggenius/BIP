...
<jsp:useBean id="listeEcartBudgetPole" scope="session" class="com.socgen.ich.ihm.menu.PaginationVector" />
...
var numtrait = "<bean:write name="ecartsBudgetsForm"  property="numtrait" />";
var msgtrait = "<bean:write name="ecartsBudgetsForm"  property="msgtrait" />";
var nexttrait = "<bean:write name="ecartsBudgetsForm"  property="nexttrait"/>";
...
window.open("/ecartsbudgets.do?action=creer&codsg="+rcodsg+"&gnom="+rnom+"&numtrait="+numtrait+"&msgtrait="+msgtrait+"&nexttrait="+nexttrait ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width='95%', height='95%'") ;
    ...
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr> 
        ...
        <tr> 
          <td height="20" class="TitrePage">Liste des Ecarts avec Message<bean:write name="ecartsBudgetsForm"  property="msgtrait" /></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
      		...
      		<logic:iterate id="element" name="listeEcartBudgetPole" length="<%= listeEcartBudgetPole.getCountInBlock() %>" 
            		offset="<%= listeEcartBudgetPole.getOffset(0) %>" type="com.socgen.bip.metier.EcartBudgetPole" indexId="index"> 
			<% if ( i == 0) i = 1; else i = 0;
						...
						<td class="contenuCenter"><bean:write name="element" property="nombre"/></td>
             	          ...
             	          <table width="100%" border="0" cellspacing="0" cellpadding="0">
					          ...
					          <td align="center" colspan="4" class="contenu">
						        <bip:pagination beanName="listeEcartBudgetPole"/>
					          </td>
				            </tr>
