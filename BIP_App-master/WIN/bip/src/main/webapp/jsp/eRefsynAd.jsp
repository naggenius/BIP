...
<bip:VerifUser page="jsp/eRefsynAd.jsp"/>
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						<td colspan=2><b>Entrez le code DPG du p&ocirc;le dont vous voulez la synth&egrave;se projet/MO :</b></td>
					</tr>
					<tr>
