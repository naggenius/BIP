...
<bip:VerifUser page="jsp/xControlePIDValide.jsp"/>
                ...
                <tr> 
                  ...
                  <tr> 
					...
					<tr>
						...
						<td><html:text property="p_param6" styleClass="input"  size="7" maxlength="7" onchange="return Ctrl_dpg_generique(this);return VerifFormat(this.name);"/></td>
					</tr>
