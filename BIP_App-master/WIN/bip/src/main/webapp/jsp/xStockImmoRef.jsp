...
<bip:VerifUser page="jsp/xStockImmoRef.jsp"/>
<%
...
//		}	
//		else{
//			sJobId = "xStockImmoAdClient";
//		}

	// la gestion de l affichage des champs est gere dans le reports 
	// qc 1321
	sJobId = "xStockImmoAd";
...
function ValiderEcran(form) {
		...
		alert('Choisir "Tous", ou un code pour au moins un des critères');
		return false;
	}
	if(selectHabil()){
...
<input type="hidden" name="jobId" value="<%=sJobId%>">
	...
	<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tableBleu" align="center">
		...
		<tr>
			<td align="left"><b>Cette extraction prend en compte votre périmètre Dossier projet, projet, CAFI et CADA.
			</td>
		</tr> 
		<tr>
			<td align="center">&nbsp;</td>
	...
	<table border=0 class="tableBleu" width="90%" cellspacing="1" align="center" cellpadding="1">
		...
		<tr>
	        <td class="lib" align=left><b>Limitation à un CADA : </b>
