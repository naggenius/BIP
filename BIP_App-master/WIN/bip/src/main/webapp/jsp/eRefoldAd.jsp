...
<bip:VerifUser page="jsp/eRefoldAd.jsp"/>
			...
			<div align=center>
				<form name ="ckF" action="">
					<table border=0 cellspacing=5 cellpadding=0 class="tableBleu">
						...
						<tr>
							<td class="lib" nowrap><B>&nbsp;PCA4 par Client&nbsp;</B></td>
							<td><input type="checkbox" name="ck1" value="1" onChange="majListe();"></td>
						</tr>
						<tr>
							<td class="lib" nowrap><B>&nbsp;PCA4 par Groupe&nbsp;</B></td>
							<td><input type="checkbox" name="ck2" value="2" onChange="majListe();"></td>
						</tr>
						<tr>
							<td class="lib" nowrap><B>&nbsp;PCA4 par Groupe et Métier&nbsp;</B></td>
							<td><input type="checkbox" name="ck4" value="4" onChange="majListe();"></td>
						</tr>
						<tr>
							<td class="lib" nowrap><B>&nbsp;PCA4 par Client avec sous-traitance&nbsp;</B></td>
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					<tr>
						...
						<td colspan=2><html:text property="p_param6" styleClass="input"  size="7" maxlength="7" onchange="return VerifFormat(this.name);"/></td>
					</tr>
					<tr><td colspan=5 align="center">&nbsp;</td></tr>
					<!-- #EndEditable -->
			   		</table>
