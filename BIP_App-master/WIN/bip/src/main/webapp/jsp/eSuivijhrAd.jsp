...
<bip:VerifUser page="jsp/eSuivijhrAd.jsp"/>
<%
	...
	java.util.ArrayList list1 = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("dirme",hP); 
	pageContext.setAttribute("listeDir", list1);
%>
...
function MessageInitial()
{
	...
	document.editionForm.p_param6.options[document.editionForm.p_param6.length] = new Option("", "", true, true);
}
...
function ValiderEcran(form)
{
	if (blnVerification)
	{
		if (!ChampObligatoire(form.p_param6, "une direction")) return false;
	}
                ...
                <tr> 
                  <td> 
					...
					<input type="hidden" name="pageAide" value="<%= sPageAide %>">
                      ...
                      <tr>
                      		<td align=center colspan=2 class="lib"><b>Direction :</b></td>
					</tr>
					<tr>
							<td align=center colspan=2>
								<html:select property="p_param6" styleClass="input"> 
   									<html:options collection="listeDir" property="cle" labelProperty="libelle" />
								</html:select>
							</td>
					  <tr>
                        <td colspan=5 align="center">&nbsp;</td>
