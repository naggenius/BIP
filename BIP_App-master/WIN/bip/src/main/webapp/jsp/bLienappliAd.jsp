      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Rattachement 
            en masse des lignes BIP - application<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
                    <html:hidden property="mode" value="APP"/>
            		<html:hidden property="table" value="APP"/>
	                  ...
	                  <td><b><bean:write name="lienLigneForm"  property="airt" /> - <bean:write name="lienLigneForm"  property="alibel" /> </b>
