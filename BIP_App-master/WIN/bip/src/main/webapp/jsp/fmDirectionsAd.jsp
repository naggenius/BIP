...
function rechercheID(){
	window.open("/recupIdDirection.do?action=initialiser&nomChampDestinataire=coddir&windowTitle=Recherche Code Direction&habilitationPage=HabilitationLigneBip"  ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width=450, height=600") ;
	return ;
}  
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des Directions<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/majDirections"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td align=center><b>Code Direction
                    : &nbsp </b></td>
                  <td> 
                     <html:text property="coddir" styleClass="input" size="2" maxlength="2" onchange="return VerifierNum(this,2,0);"/>
                      	<a href="javascript:rechercheID();"><img border=0 src="/images/p_zoom_blue.gif"  alt="Rechercher Identifiant" title="Rechercher Direction"  align="absbottom" ></a>
				</td>
                </tr>
                <tr> 
                  <td align=center>&nbsp;</td>
