...
<bip:VerifUser page="jsp/eSsttntAd.jsp"/>
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
                        <td colspan=2 align=center class="lib"><b>Cat&eacute;gorie de sous-traitance :</b></td>
                      </tr>
					<tr>
						<td><input type=radio name="listeReports" value="1" checked>Sous-traitance re&ccedil;ue</td>
						<td><input type=radio name="listeReports" value="2">Sous-traitance fournie</td>
					</tr>
					  <tr>
                        <td colspan=5 align="center">&nbsp;</td>
                      </tr>
