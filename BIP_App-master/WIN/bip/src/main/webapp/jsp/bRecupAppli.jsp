...
<jsp:useBean id="RecupAppliForm" scope="request" class="com.socgen.bip.form.RecupAppliForm" />
...
{
   var Message="<bean:write filter="false"  name="RecupAppliForm"  property="msgErreur" />";
   var Focus = "<bean:write name="RecupAppliForm"  property="focus" />";
...
function fill(num)
{
	var cible = "<%=RecupAppliForm.nomChampDestinataire%>";
...
<!--         </tr> -->
        <tr> 
          <td height="20" class="TitrePage"><bean:write name="RecupAppliForm" property="windowTitle" /></td>
        </tr>
<!--         <tr>  -->
<!--           <td background="../images/ligne.gif"></td> -->
<!--         </tr> -->
        ...
        <tr> 
          <td><html:form action="/recupAppli.do">
...
<html:hidden property="action" value="modifier"/>
                     ...
                     <html:hidden name="RecupAppliForm" property="nomChampDestinataire"/>
                     <html:hidden name="RecupAppliForm" property="windowTitle"/>
                     <html:hidden name="RecupAppliForm" property="habilitationPage"/>  
                       
                     <input type="hidden" name="index" value="modifier">                                                          
                        <table align="center">					
				        	<tr align="left">
				            	<td class="texte">Application :&nbsp;<BR>
				                 (Veuillez saisir les premières lettres du libell&eacute;)
				                </td>
				                <td>
         				...
         				<table align="center" width=80%>            	
            				 ...
            				 <tr align="left">
            					<td colspan="3" class="texte" ><b>Le nombre de codes trouvés est supérieur à 100<BR>
							...
							<% if  	(listeRechercheId.size()>0){%>
								<tr align="left">
									<td colspan ="2" class="contenu">Cliquez sur un code Application pour le sélectionner</td>
								</tr>
								
 								<tr align="left">
					 				<td class="lib" width="25%" >Code Appli</td>
								...
								<logic:iterate id="element"  name="listeRechercheId"  length="<%=listeRechercheId.getCountInBlock()%>" 
									...
									type="com.socgen.bip.metier.InfosAppli"
									indexId="index"> 
									<% if ( i == 0) i = 1; else i = 0;%>
						...
						<table  align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
			   				<tr>
								<td align="center" colspan="2" class="contenu"></td>					
							</tr>
							<tr>
								<td align="center" colspan="2" class="contenu"></td>
							</tr>
