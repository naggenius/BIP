...
<bip:VerifUser page="jsp/eRubriqueAd.jsp"/>
...
function ValiderEcran(form){
	if (blnVerification)
	{
		if (!ChampObligatoire(form.p_param6,"un code CAFI")) return false;
	}
	return true;
}
...
function rechercheCA(){
    window.open("/recupIdCa.do?action=initialiser&nomChampDestinataire=p_param6&rafraichir=NON&windowTitle=Recherche CA payeur&habilitationPage=HabilitationLigneBip"  ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width=450, height=450") ;
	return ;
}
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr> 
						<td class="lib"><b>CA FI : </b></td>
						<td> <html:text property="p_param6" styleClass="input" size="7" maxlength="7" onchange="return VerifFormat(this.name);"/> 
						&nbsp;&nbsp;<a href="javascript:rechercheCA();"  ><img border=0 src="/images/p_zoom_blue.gif" alt="Rechercher CAFI" title="Rechercher CAFI" align="absbottom"></a>
                        </td>
					</tr>
					<tr>
                        <td colspan=5 align="center">&nbsp;</td>
