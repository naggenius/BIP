...
<!--         </tr> -->
    ...
    <BR/>    
     <html:form action="/forfait">  
     <html:hidden property="action" value="creer2"/>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
    ...
    <table border=0 cellspacing=2 cellpadding=2 class="TableBleu" align="center">    
      	...
      	<tr align="left"><td class="texte"></td></tr>
      	<tr align="left"><td class="texte"></td></tr>
                 <tr align="left">
		        <td class="texte" colspan=5 align="center"><b>Frais d'environnement</td>
		     </tr>
	        <tr align="left"> 
          		<td colspan=5><br/><br/> &nbsp;</td>
        				</tr>
	                   	  	<tr>
	                   			<td class="texte"><html:radio property="typeForfait" value="F">AVEC</html:radio></td>
	                   			<td>&nbsp;</td>
	                          	<td class="texte"><html:radio property="typeForfait" value="E">SANS</html:radio></td>
	                          	<td>&nbsp;</td>
