...
<bip:VerifUser page="jsp/eModeContractuelAd.jsp"/>
...
<%
	String sTitre;
	String sInitial;
	String sJobId="e_modecontractuel";
%>
...
{
	var index = form.p_param6.selectedIndex ;
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						<td>
						<table><tr>
                        <td align=center class="lib"><B>Liste des Modes contractuels :&nbsp;</B></td>
                        </tr></table>
                        </td>
						<td align=center>
							<select name="p_param6" class="input" size="2">
                            <option value="T">Tous</option>
                            <option value="A">Actifs</option>
                          </select>
						</td>
					</tr>
					<tr><td colspan=5 align="center">&nbsp;</td></tr>
