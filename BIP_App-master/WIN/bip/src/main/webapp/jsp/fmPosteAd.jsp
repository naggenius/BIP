...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (form.poste && !ChampObligatoire(form.poste,"le code poste d'investissement")) return false;
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des postes d'investissement<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/majposte"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>           		
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  <td align=center><b>Code poste d'investissement : &nbsp </b></td>
                  <td> 
                     <html:text property="poste" styleClass="input" size="4" maxlength="4" onchange="return VerifierNum(this,4,0);"/>
		  </td>
                </tr>
                <tr> 
                  <td align=center>&nbsp;</td>
