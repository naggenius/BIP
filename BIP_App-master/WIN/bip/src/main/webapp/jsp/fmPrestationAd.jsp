...
function MessageInitial()
{
  ...
  if (Focus != "") (eval( "document.forms[0]."+Focus )).focus();
	  ...
	  document.forms[0].codprest.focus();
   }
}
...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	...
	if (!ChampObligatoire(form.codprest, "une prestation")) return false;
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des Prestations<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="action" value="creer"/>
		   	 <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                      ...
                      <tr> 
                        <td align="center"><b>Prestation  </b> : 
                       <html:text property="codprest" styleClass="input" size="4" maxlength="3" onchange="return VerifierAlphaMax(this);"/>
                    	<tr> 
                        <td>&nbsp; </td>
                      </tr>
                      <tr> 
