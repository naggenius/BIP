...
<bip:VerifUser page="jsp/eProfilsListeRessourcesAd.jsp"/>
    ...
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr> 
        ...
        <tr> 
          <td>
		  	<!-- #BeginEditable "debut_form" --><html:form action="/editerProfils" enctype="multipart/form-data"><!-- #EndEditable -->
            ...
            <table align="center" border="0">
						...
						<table border="0" cellspacing="0" cellpadding="2" class="tableBleu" style="border:solid 1px solid">
		                    ...
		                    <!-- Si un envoi au serveur a été effectué -->
						  	<logic:notEmpty name="editerProfilsForm" property="statut"> 
							  	<tr>
			                       <td align="left" >Format et contenu du fichier :</td>
			                       <td><bean:write name="editerProfilsForm"  property="statut" /></td>
			                    </tr>
			                    <tr>
			                       <td align="left" >Nombre d'enregistrements lus au total :</td>
			                       <td><bean:write name="editerProfilsForm"  property="nbEnregistrementsLus" /></td>
			                    </tr>
			                    <tr>
			                       <td align="left" >Identifi&eacute;s Bip :</td>
			                       <td><bean:write name="editerProfilsForm"  property="nbEnregistrementsIdentifiesBip" /></td>
			                    </tr>
			                    <tr>
			                       <td align="left">
	        		...
	        		<tr> 
		                <td colspan=2> 
		                    <div align="center">
			        			<table border=0 cellspacing=0 cellpadding=2 class="tableBleu" style="border:solid 1px solid">
				        			<tr align="center">
				                    	<td align="center" style="padding-right : 10px;" class="lib"><b>ID_RESSBIP</b></td>
				                    	<td align="center" style="padding-left : 10px;" class="lib"><b>ID_RTFE</b></td>
				                    	<% 
				                    	...
				                    	%>
				                    	<td style="width:18px" class="lib"></td>
				                    	<% 
				                    	} 
				                    	%>
				                    </tr>
        		...
        		<div align="center">
	        		...
	        		<logic:equal name="editerProfilsForm" property="statut" value="<%= EditerProfilsForm.statutOk %>"> 
		        		<tr align="center">
		          			<td colspan=2 >
		          				<b>Lancement de l'&eacute;dition des Profils Bip ?</b>
		          			</td>
		        		</tr>
		        		<tr>
	          				<td colspan=2>&nbsp;  
