...
<bip:VerifUser page="jsp/eLogslbAd.jsp"/>
                ...
                <tr> 
                  <td> 
					...
					<tr>
						...
						<td><html:text property="p_param6" styleClass="input"  size="4" maxlength="4" onchange="return VerifierAlphaMax(this);"/></td>
					</tr>
					  <tr>
                        <td colspan=5 align="center">&nbsp;</td>
                      </tr>
