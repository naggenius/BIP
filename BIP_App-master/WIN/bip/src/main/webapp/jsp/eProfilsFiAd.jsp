...
<title>IMPRESSION DES PROFILS DE FI: Sélection</title>
<!-- #EndEditable -->
...
function ValiderEcran(form) {
	...
	if (blnVerification==true) {
		...
		if (!ChampObligatoire(document.forms[0].p_param7, "* pour toutes les périodes ou une date (MM/AAAA)")) return false;
		}
			...
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr><td>&nbsp;</td> 
                  ...
                  <td> 
					...
					&nbsp;&nbsp; (* pour toutes périodes, ou à compter du mois MM/AAAA)
				  </td>
                </tr>
                <tr> <td>&nbsp;</td>
