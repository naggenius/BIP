...
<jsp:useBean id="RecupDPGForm" scope="request" class="com.socgen.bip.form.RecupDPGForm" />
...
{
   var Message="<bean:write filter="false"  name="RecupDPGForm"  property="msgErreur" />";
   var Focus = "<bean:write name="RecupDPGForm"  property="focus" />";
...
function fill(num)
{
	var cible = "<%=RecupDPGForm.nomChampDestinataire%>";
	var action = "<%=RecupDPGForm.rafraichir%>";
...
<!--         </tr> -->
        <tr> 
          <td height="20" class="TitrePage"><bean:write name="RecupDPGForm" property="windowTitle" /></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        ...
        <tr> 
          <td><html:form action="/recupDPG.do">
...
<html:hidden property="action" value="modifier"/>
                     ...
                     <html:hidden name="RecupDPGForm" property="nomChampDestinataire"/>
                     <html:hidden name="RecupDPGForm" property="windowTitle"/>
                     <html:hidden name="RecupDPGForm" property="habilitationPage"/>  
                     <html:hidden name="RecupDPGForm" property="rafraichir"/>
