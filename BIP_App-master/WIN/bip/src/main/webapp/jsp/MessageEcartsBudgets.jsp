...
<jsp:useBean id="messageEcartsBudgets" scope="session" class="com.socgen.bip.metier.MessageEcartsBudgets" />
...
<%
    ...
    Vector msg =  messageEcartsBudgets.getMessage();
...
var codsg = "<%= messageEcartsBudgets.getCodsg() %>";
var gnom = "<%= messageEcartsBudgets.getGnom() %>";
...
%>
  ...
  message = message + "%0a%0a=====> <%= ecartsBudgetsForm.getNexttrait() %>";

  message = message + "%0a%0a%0a   Cordialement";
	
  message = "mailto:" + gnom + "?subject=Liste des &eacute;carts BIP<%= ecartsBudgetsForm.getMsgtrait() %>" + "&body=" + message;	
    ...
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr> 
        ...
        <tr> 
          <td height="20" class="TitrePage">Liste des Ecarts du groupe <%= messageEcartsBudgets.getCodsg() %> <%= ecartsBudgetsForm.getMsgtrait() %></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        ...
        <tr> 
          <td align="left" width="10%" class="fond2"><b>Le responsable du groupe :</b><%= messageEcartsBudgets.getGnom() %></td>
        </tr>
        ...
        <tr> 
          <td align="left" width="10%" class="fond2"><b>L'objet :</b> Liste des &eacute;carts BIP<%= ecartsBudgetsForm.getMsgtrait() %></td>
        </tr>
        ...
        <tr> 
          <td>
          	&nbsp;&nbsp;Bonjour,
          	<br>&nbsp;&nbsp;&nbsp;Voici la liste des &eacute;carts de saisie qui concernent les ressources de votre groupe <%= messageEcartsBudgets.getCodsg() %> :
          	<br>
          ...
          <br><br>
         <font color=red><b>&nbsp;=====> <%= ecartsBudgetsForm.getNexttrait() %></b></font>
