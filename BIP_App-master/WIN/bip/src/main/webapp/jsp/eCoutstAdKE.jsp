...
<bip:VerifUser page="jsp/eCoutstAdKE.jsp"/>
    ...
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr> 
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Edition des coûts moyens complets<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
            ...
            <table width="100%" border="0">
                ...
                <tr> 
                  <td> 
					...
					<tr>
						<td class="lib">Ann&eacute;e du co&ucirc;t moyen complet :</td>
