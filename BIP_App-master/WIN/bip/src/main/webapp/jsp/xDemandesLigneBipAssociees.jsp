...
<!-- Le nom de la page à utiliser dans bip:VerifUser ne doit pas être jsp/xDemandesLigneBipAssociees.jsp . Il doit rester jsp/xRedirectDemandeLigneBip.jsp -->
...
<%
	...
	String ssMenuSuivbase = "oui";
	if ((user.getSousMenus()).indexOf("SUIVBASE") == -1 && (user.getSousMenus()).indexOf("suivbase") == -1 && !menu.getId().equalsIgnoreCase("GENERAL"))
		ssMenuSuivbase = "non";
...
function MessageInitial()
{
	...
	else
	{
		...
		document.forms[0].p_param12.focus();
		document.extractionForm.p_param7.checked = false;
	}

	<%
	sJobId = "xDdeLigneBipSuivbase";
        ...
        <tr> 
          <td><div id="outils" align="center"><!-- #BeginEditable "barre_haut" -->
              <%ToolBarNew tb = new com.socgen.ich.ihm.ToolBarNew("bip_ihm",false,false,true,true,false,false,false,false,false,request) ;%>
				...
				<li><a href="javascript:ajouterFavoris('Extract. des demandes et lignes BIP','/jsp/xRedirectDemandeLigneBip.jsp&param0=pageAide&value0=/jsp/aide/Guide_Resp_etudes.doc&param1=typFav&value1=X&param2=addFav&value2=yes&param3=jobId&value3=&param4=titlePage&value4=&param5=lienFav&value5=%2Fjsp%2FxRedirectLigne.jsp&param6=sousMenu&value6=&param7=indexMenu&value7=71&param8=arborescence&value8=Responsable%20d études/Exports%20sur%20PC/Extract.%20des%20demandes%20et%20lignes%20BIP','X');" onmouseover="window.status='';return true"  >Ajouter aux favoris</a></li></ul> -->
...
<!--           <td background="../images/ligne.gif"></td> -->
        ...
        <tr> 
		  ...
		  <html:form action="/extract"  onsubmit="return ValiderEcran(this);">
            ...
            <input type="hidden" name="p_param14" value="<%= ssMenuSuivbase %>">
                  ...
                  <td> 
					...
					<table border=0 cellspacing=5 cellpadding=0 class="tableBleu">
						...
						<tr align="left">
							...
							<%-- <td class="texte" colspan=1 align=left><html:text property="p_param6" styleClass="input"  size="12" maxlength="7" onchange="VerifFormat(this.name); DPG_Change();"></html:text> --%>
