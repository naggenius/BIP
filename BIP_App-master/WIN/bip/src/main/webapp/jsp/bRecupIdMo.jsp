...
<!--         </tr> -->
        <tr> 
          <td class="TitrePage"><bean:write name="RecupIdMoForm" property="windowTitle" /></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        ...
        <tr> 
          <td><html:form action="/recupIdMo.do">
...
<html:hidden property="action" value="modifier"/>
                     ...
                     <input type="hidden" name="index" value="modifier">                                                          
                        <table align="center">					
				                     	  <tr align="left">
				                     		<td class="texte">Libell&eacute; du client :&nbsp;<BR>
         ...
         <table align="center">            	
            ...
            <tr align="left"><td colspan="3" class="contenu"><b>Le nombre de Code Client trouv&eacute;es est sup&eacute;rieur &agrave;100<BR>
...
<tr align="left"><td colspan ="2" class="contenu">Cliquez sur un Code client pour le s&eacute;lectionner</td></tr>
<BR>
 <tr align="left">
...
<logic:iterate id="element"  name="listeRechercheIdMo"  length="<%=listeRechercheIdMo.getCountInBlock()%>" 
          offset="<%=listeRechercheIdMo.getOffset(0)%>"
				   ...
				   <tr align="left" class="<%= strTabCols[i] %>">
					...
					<tr>
						<td align="center" colspan="3" class="contenu">
						<b><bip:pagination beanName="listeRechercheIdMo"/></b>
					</td>
					</tr>						
