...
function MessageInitial()
{
	...
	if ((menu == "ME" && (ssMenus.indexOf("SUIVBASE") > -1 || ssMenus.indexOf("suivbase") > -1)) || menu == "GENERAL" )
	{
		...
		if(menu.equalsIgnoreCase("GENERAL")){
				sTitlePage="Extract. S-tâches/ress. tout public";
		}	
		else {
			sTitlePage="Extraction sous-tâche / ressources";
	}
		%>
...
<input type="hidden" name=titlePage value="Extraction sous-tâche / ressources">
