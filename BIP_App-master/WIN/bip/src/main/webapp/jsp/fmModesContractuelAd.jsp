...
function ValiderEcran(form)
{
   if (blnVerification==true) {
	if (form.codcontractuel && !ChampObligatoire(form.codcontractuel,"le code du mode contractuel")) return false;
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des modes Contractuels<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/majModesContractuel"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="action" value="creer"/>
			<table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  	<td align=center><b>Code Mode Contractuel
                    	: &nbsp </b></td>
                  	<td> 
                     <html:text property="codcontractuel" styleClass="input" size="3" maxlength="3" onchange="return VerifierAlphaMaxCarSpecModeContractuel(this);"/>
					</td>
                </tr>
                <tr> 
                  <td align=center>&nbsp;</td>
