...
<bip:VerifUser page="jsp/xPrjCada.jsp"/>
...
{
   if (blnVerification) {
        if (!ChampObligatoire(form.p_param6, "un CADA")) return false;
   }
                    ...
                    <div align="center">
                      <!-- #BeginEditable "contenu" -->
						<table border=0 cellspacing=5 cellpadding=0 class="tableBleu">
							...
							<tr>
								<td colspan=1 class="lib" align=right><b>Entrez le CADA :</b>&nbsp;</td>
								<td colspan=1 align=left>
									<html:text property="p_param6" styleClass="input"  size="7" maxlength="5" onchange="return VerifierNum(this, 5, 0);"/>
								</td>
                    		</tr>
                    		<tr>
                        		<td colspan=2 align="center">&nbsp;</td>
