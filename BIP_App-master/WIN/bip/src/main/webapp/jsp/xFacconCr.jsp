...
<bip:VerifUser page="jsp/xFacconCr.jsp"/>
            ...
            <table width="100%" border="0">
                <tr> 
                  <td> 
					...
					<tr>
						<td colspan=1 class="lib" align=right><b>Extension du fichier :</b>&nbsp;</td>
						<td colspan=1>
                          <select name="listeReports" class="input" onChange="return MAJTypeExtract(this.value)">
							<option value="1;3;5" SELECTED>.TXT</option>
							<option value="2;4;6">.CSV</option>
                          </select>
						</td>
                    </tr>
			   		</table>
