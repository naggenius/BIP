...
<bip:VerifUser page="jsp/eLibAl.jsp"/>
...
function ValiderEcran(form)
{
	if (blnVerification)
	{
		...
		if (!ChampObligatoire(form.p_param6,"la chaîne de caractères à rechercher")) return false;
	}
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						<td colspan=2 class="lib"><B>Cha&icirc;ne de caract&egrave;res &agrave; rechercher :</B></td>
                      </tr>
					<tr>
						<td colspan=2><html:text property="p_param6" styleClass="input"  size="50" maxlength="50" onchange="return VerifFormat(this.name);"/></td>
					</tr>
					<tr>
						<td colspan=2>Renvoie les éléments dont le libellé <B>comprend</B> les caractères saisis</td>
                      </tr>
