...
<%
  java.util.ArrayList list1 = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("projspec",projspecForm.getHParams()); 
  pageContext.setAttribute("choixProjspec", list1);
%> 
...
{
   var index = form.codpspe.selectedIndex;

   if (blnVerification==true) {
  
	if ( (index==-1) && (form.action.value != 'creer') ) {
         alert("Choisissez un projet spécial");
	   return false;
	}
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise &agrave; jour des Projets spéciaux<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        <tr> 
          <td>
		  <!-- #BeginEditable "debut_form" --><html:form action="/projspec"  onsubmit="return ValiderEcran(this);"><!-- #EndEditable -->
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
              <table cellspacing="2" cellpadding="2" class="tableBleu"   >
                ...
                <tr> 
                  <td    class="lib" colspan=2 align=center><b>Projets sp&eacute;ciaux : </b></td>
                </tr>
                <tr> 
                  <td  colspan="2" align="center">
                  <html:select property="codpspe" styleClass="input" size="10"> 
   						<html:options collection="choixProjspec" property="cle" labelProperty="libelle" />
						</html:select>
