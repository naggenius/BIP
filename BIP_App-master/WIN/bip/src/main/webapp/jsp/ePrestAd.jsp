...
<bip:VerifUser page="jsp/ePrestAd.jsp"/>
...
function MessageInitial()
{
	...
	{
		annee_precedente = <%= com.socgen.bip.commun.Tools.getStrDateAAAA(-1) %>;
		document.editionForm.p_param6.value = "01/" + annee_precedente ;
		document.editionForm.p_param7.value = "12/" + annee_precedente ;
		document.editionForm.p_param8.value = "01/01/<%= com.socgen.bip.commun.Tools.getStrDateAAAA(0) %>";
	}
