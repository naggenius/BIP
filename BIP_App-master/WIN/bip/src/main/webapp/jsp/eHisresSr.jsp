...
<bip:VerifUser page="jsp/eHisresSr.jsp"/>
<%
	...
	java.util.ArrayList listeRessCons = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("isac_resscons", hP); 
	pageContext.setAttribute("choixRessCons", listeRessCons);
%>
...
function MessageInitial()
{
	...
	tabVerif["p_param8"]  = "verifToutIsac(document.editionForm.p_param6, document.editionForm.p_param8)";
	...
	all = new Option("Tous", "Toute");
	if (document.editionForm.p_param8.length>1)
		document.editionForm.p_param8.options[document.editionForm.p_param8.length] = all;
}
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						...
						<td>
							<html:select property="p_param8" styleClass="input" onchange="return VerifFormat(this.name);"> 
							<html:options collection="choixRessCons" property="cle" labelProperty="libelle" />
							</html:select>
                		</td>
					</tr>
					  <tr>
