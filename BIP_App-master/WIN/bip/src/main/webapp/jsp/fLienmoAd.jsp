...
<bip:VerifUser page="jsp/fLienmoAd.jsp"/> 
...
function ValiderEcran(form)
{
  if (blnVerification==true) {
     if (form.action.value!="valider")
  		form.action.value ="suite";
     if (!ChampObligatoire(form.clicode, "un code client MO")) return false;
  }

   return true;
}
function rechercheID(){
	window.open("/recupIdMo.do?action=initialiser&nomChampDestinataire=clicode&windowTitle=Recherche Code MO&habilitationPage=HabilitationLigneBip"  ,"", "toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width=450, height=450") ;
	return ;
} 
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
            <html:hidden property="table" value="MO"/>
              <table border=0  cellpadding=2 cellspacing=2 class="tableBleu">
                ...
                <tr> 
                  ...
                  <td><html:text property="clicode" styleClass="input" size="6" maxlength="5" onchange="return VerifierAlphaMax(this);"/>
