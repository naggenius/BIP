...
<!--         </tr> -->
        ...
        <BR>
        <tr> 
          <td><html:form action="/recupIdPersonne.do">
...
<html:hidden property="action" value="modifier"/>
                     ...
                     <input type="hidden" name="index" value="modifier">                                                          
                        <table align="center">					
				                     	  <tr>
				                     		<td align="left" class="texte">Nom de la personne :&nbsp;<BR>
         ...
         <table>            	
            ...
            <tr><td align="left" colspan="3" class="contenu"><B>Le nombre de personnes trouvées est supérieur à 100<BR>
...
<tr><td align="left" colspan ="3" class="contenu">Cliquez sur un code d'une personne pour la sélectionner</td></tr>
<BR>
 <tr>
 <td align="left" class="lib" width="30%">Code</td>
 <td align="left" class="lib"width="30%">Nom</td>
 <td align="left" class="lib"width="30%">Prénom</td>
</tr>
