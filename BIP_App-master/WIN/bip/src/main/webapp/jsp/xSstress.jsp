...
<!-- Le nom de la page à utiliser dans bip:VerifUser ne doit pas être jsp/xSstress.jsp . Il doit rester jsp/xRedirectSstress.jsp -->
...
<%
	...
	/* BIP-541 - p_Perim_ME is null for ME/suivbase and General menus*/
	String p_Perim_ME = "";
...
function MessageInitial()
{
	...
	<%
	sJobId = "xSstresAdSuivbase";
	//sTitre = com.socgen.bip.metier.Report.getTitre(sJobId);
	sTitre = "Extraction des sous-taches par ressource";
	if (sTitre == null)
	{
...
function MAJAxeRecherche(typeAxe){
	...
	document.extractionForm.p_param13.value=typeAxe;
	return true;
}
...
<!--         </tr> -->
        ...
        <tr> 
		  ...
		  <html:form action="/extract"  onsubmit="return ValiderEcran(this);">
            ...
            <input type="hidden" name="p_param17" value="<%= p_Perim_ME %>">
                  ...
                  <td> 
					...
					<table border=0 cellspacing=5 cellpadding=0 class="tableBleu">
						...
						<tr align="left">
							...
							<td colspan=1>
								<select name="p_param13" class="input" onChange="return MAJAxeRecherche(this.value)">
									<option value="Tous" SELECTED>Tous</option>
									<option value="ress">DPG de ressource</option>
									<option value="ligne">DPG de ligne</option>
								</select>
							</td>
						</tr>
						<tr align="left">
