...
<bip:VerifUser page="jsp/eLogBudgetCopi.jsp"/>
...
{
   if (blnVerification) {
        if (!ChampObligatoire(form.p_param6, "un code Dp-Copi")) return false;
   }
            ...
            <table width="100%" border="0">
                ...
                <tr> 
                  <td> 
					...
					<tr>
						<td class="lib"><B>Code Dp-Copi :</B></td>
						<td><html:text property="p_param6" styleClass="input"  size="6" maxlength="6" onchange="return VerifierAlphaMax(this);"/></td>
						<td class="lib"><B>Annee :</B></td>
						<td><html:text property="p_param7" styleClass="input"  size="4" maxlength="4" onchange="return VerifierAlphaMax(this);"/></td>
					</tr>
					  <tr>
                        <td colspan=5 align="center">&nbsp;</td>
                      </tr>
