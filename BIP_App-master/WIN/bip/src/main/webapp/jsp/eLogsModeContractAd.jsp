...
<bip:VerifUser page="jsp/eLogsModeContractAd.jsp"/>
...
<%
	String sTitre;
	String sInitial;
	String sJobId="eLogsModeContractAd";
%>
...
{
   if (blnVerification) {
        if (!ChampObligatoire(form.p_param6, "un code contractuel")) return false;
   }
   VerifierAlphaMaxCarSpecModeContractuel(form.p_param6);
                ...
                <tr> 
                  <td> 
					...
					<table border=0 cellspacing=2 cellpadding=2 class="tableBleu">
					  ...
					  <tr>
                        <td align="center"><b>Code contractuel :</b></td>
                        <td> 
                  	        <html:text property="p_param6" styleClass="input" size="3" maxlength="3" onchange="this.value = this.value.toUpperCase();return VerifierAlphaMaxCarSpecModeContractuel(this);"/>&nbsp;
					        </td>
					  </tr>
		   		    </table>
					</div>
