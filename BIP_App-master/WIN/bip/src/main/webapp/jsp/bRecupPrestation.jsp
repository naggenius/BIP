...
<jsp:useBean id="RecupPrestationForm" scope="request" class="com.socgen.bip.form.RecupPrestationForm" />
...
{
   var Message="<bean:write filter="false"  name="RecupPrestationForm"  property="msgErreur" />";
   var Focus = "<bean:write name="RecupPrestationForm"  property="focus" />";
...
function fill(num)
{
	var cible = "<%=RecupPrestationForm.nomChampDestinataire%>";
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><bean:write name="RecupPrestationForm" property="windowTitle" /></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        ...
        <BR>
        <tr> 
          <td><html:form action="/recupPrestation.do">
...
<html:hidden property="action" value="modifier"/>
                     ...
                     <html:hidden name="RecupPrestationForm" property="nomChampDestinataire"/>
                     <html:hidden name="RecupPrestationForm" property="windowTitle"/>
                     <html:hidden name="RecupPrestationForm" property="habilitationPage"/>  
                       
                     <input type="hidden" name="index" value="modifier">                                                          
                        <table align="center">					
				        	<tr>
				            	<td class="lib">Code Prestation :&nbsp;<BR>
         				...
         				<table width=80%>            	
            				 ...
            				 <tr>
            					<td colspan="3" class="contenu"><B>Le nombre de codes trouvés est supérieur à 100<BR>
            		 			 Veuillez saisir un libell&eacute; plus long afin de mieux limiter la recherche</B>
            					</td>
            				 </tr>
            				 <tr>
            					<td >&nbsp;</td>
							...
							<% if  	(listeRechercheId.size()>0){%>
								<tr>
									<td colspan ="4" class="contenu">Cliquez sur un code prestation pour le sélectionner</td>
								</tr>
								<BR>
 								<tr>
					 				<td class="lib" width="25%" >Code Prestation</td>
								...
								<logic:iterate id="element"  name="listeRechercheId"  length="<%=listeRechercheId.getCountInBlock()%>" 
									...
									type="com.socgen.bip.metier.InfosPrestation"
									indexId="index"> 
									<% if ( i == 0) i = 1; else i = 0;%>
