...
<bip:VerifUser page="jsp/eCoutstAd.jsp"/>
            ...
            <table width="100%" border="0">
                ...
                <tr> 
                  <td> 
					...
					<tr>
						<td colspan=3 class="lib"><b>Co&ucirc;ts Standards : </b></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td><input type=radio name="listeReports" value="sg" checked>&nbsp;Ressource SG</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td><input type=radio name="listeReports" value="mat">Matériels et Environnement</td>
						<td>&nbsp;</td>
					</tr>
					  <tr>
                        <td colspan=3 align="center">&nbsp;</td>
					...
					<tr>
						...
						<td><input type="text" name="p_param6" maxlength="4" size="4" onchange="return VerifierDate(this,'aaaa');"/></td>
						<td>&nbsp;</td>
					</tr>
					  <tr>
                        <td colspan=3 align="center">&nbsp;</td>
