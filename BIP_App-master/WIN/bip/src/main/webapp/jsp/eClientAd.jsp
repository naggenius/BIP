...
<bip:VerifUser page="jsp/eClientAd.jsp"/>
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						<td class="lib"><b>Ordre de tri :</b></td>
					</tr>
					<tr>
						<td> <input type=radio name="p_param6" value="" checked>&nbsp;Par Code&nbsp; </td>
					</tr>
					<tr>
						<td> <input type=radio name="p_param6" value="LIB">&nbsp;Par Libellé&nbsp;</td>
					</tr>
					<tr><td colspan=5 align=center>&nbsp;</td></tr><tr>
					<!-- #EndEditable -->
			   		</table>
