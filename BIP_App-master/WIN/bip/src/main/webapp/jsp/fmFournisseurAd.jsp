...
<%
fournisseurForm.getHParams().put("keyList0",fournisseurForm.getSoccode());
  java.util.ArrayList list1 = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("fournisseur",fournisseurForm.getHParams()); 
...
function MessageInitial()
{
   ...
   document.forms[0].socfour.selectedIndex = 0;
}
...
{
   var index = form.socfour.selectedIndex;
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Mise à jour d'un fournisseur<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
		    ...
		    <html:hidden property="keyList0"/>
              <table cellspacing="2" cellpadding="2" class="tableBleu" >
                ...
                <tr> 
                  ...
                  <td > 
                    <div align="left"><b> <bean:write name="fournisseurForm"  property="soccode" /></b>
              ...
              <table class="tableBleu">
                ...
                <tr> 
                  <td  colspan=3> 
                    <div align="center"> 
                    	<html:select property="socfour" styleClass="input" size="5"> 
