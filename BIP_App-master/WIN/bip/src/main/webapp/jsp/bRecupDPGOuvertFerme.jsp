...
<!-- FAD PPM 63560: Duplication de bRecupDPG.jsp pour recupérer les DPG ouverts et fermés -->

<!-- Imports --> 
<%@ page language="java" import="org.owasp.esapi.ESAPI,java.sql.*,java.io.*,javax.servlet.*,javax.servlet.http.*,com.socgen.ich.ihm.*"    errorPage="../jsp/erreur.jsp"  %>
<jsp:useBean id="RecupDPGOuvertFermeForm" scope="request" class="com.socgen.bip.form.RecupDPGOuvertFermeForm" />
...
{
   var Message="<bean:write filter="false"  name="RecupDPGOuvertFermeForm"  property="msgErreur" />";
   var Focus = "<bean:write name="RecupDPGOuvertFermeForm"  property="focus" />";
...
function fill(num)
{
	var cible = "<%=RecupDPGOuvertFermeForm.nomChampDestinataire%>";
	var action = "<%=RecupDPGOuvertFermeForm.rafraichir%>";
	
	window.opener.document.forms[0].elements[cible].value = lpad(num,'0',7);
...
<!--         </tr> -->
        <tr> 
          <td height="20" class="TitrePage"><bean:write name="RecupDPGOuvertFermeForm" property="windowTitle" /></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        ...
        <tr> 
          <td><html:form action="/recupDPGOuvertFerme.do">
...
<html:hidden property="action" value="modifier"/>
                     ...
                     <html:hidden name="RecupDPGOuvertFermeForm" property="nomChampDestinataire"/>
                     <html:hidden name="RecupDPGOuvertFermeForm" property="windowTitle"/>
                     <html:hidden name="RecupDPGOuvertFermeForm" property="habilitationPage"/>  
                     <html:hidden name="RecupDPGOuvertFermeForm" property="rafraichir"/>
                                            
                     <input type="hidden" name="index" value="modifier">                                                          
                        <table align="center">					
				        	<tr align="left">
				            	<td class="texte">Code DPG :&nbsp;<BR>
         				...
         				<table width=80%>            	
							...
							<% if  	(listeRechercheId.size()>0){%>
								<tr align="left">
									<td colspan ="2" class="contenu">Cliquez sur un code DPG pour le sélectionner</td>
								</tr>
								<BR>
 								<tr align="left">
					 				<td class="lib" width="25%" >Code DPG</td>
								...
								<logic:iterate id="element"  name="listeRechercheId"  length="<%=listeRechercheId.getCountInBlock()%>" 
									...
									type="com.socgen.bip.metier.InfosDPG"
									indexId="index"> 
									<% if ( i == 0) i = 1; else i = 0;%>
