      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><!-- #BeginEditable "titre_page" -->Rattachement 
            en masse des lignes BIP - projets<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
                    <html:hidden property="mode" value="PRJ"/>
            		<html:hidden property="table" value="PRJ"/>
                      ...
                      <tr> 
                        <td align=center><b>Code projet : </b></td>
		                  <td><b><bean:write name="lienLigneForm"  property="icpi" /> - <bean:write name="lienLigneForm"  property="ilibel" /> </b>
