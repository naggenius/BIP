...
<bip:VerifUser page="jsp/eHisresCr.jsp"/>
...
function MessageInitial()
{
	...
	if (Message != "") {
		...
		document.editionForm.p_param8.value = "00000" ;
	}
...
function ValiderEcran(form)
{
	if (blnVerification) {
		...
		if (!ChampObligatoire(form.p_param8, "un identifiant de ressource")) return false;
...
<input type="hidden" name="pageAide" value="<%= sPageAide %>">
					...
					<tr>
						...
						<td><html:text property="p_param8" styleClass="input"  size="5" maxlength="5" onchange="return VerifFormat(this.name);"/></td>
					</tr>
