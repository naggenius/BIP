...
<jsp:useBean id="RecupIdProjetForm" scope="request" class="com.socgen.bip.form.RecupIdProjetForm" />
...
{
   var Message="<bean:write filter="false"  name="RecupIdProjetForm"  property="msgErreur" />";
   var Focus = "<bean:write name="RecupIdProjetForm"  property="focus" />";
...
function fill(num)
{
	var cible = "<%=RecupIdProjetForm.nomChampDestinataire%>";
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage"><bean:write name="RecupIdProjetForm" property="windowTitle" /></td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
        ...
        <BR>
        <tr> 
          <td><html:form action="/recupIdProjet.do">
...
<html:hidden property="action" value="modifier"/>
                     ...
                     <html:hidden name="RecupIdProjetForm" property="nomChampDestinataire"/>
                     <html:hidden name="RecupIdProjetForm" property="windowTitle"/>
                     <html:hidden name="RecupIdProjetForm" property="habilitationPage"/>  
                       
                     <input type="hidden" name="index" value="modifier">                                                          
                        <table align="center">					
				        	<tr>
				            	<td class="lib">Code Projet :&nbsp;<BR>
				                 (Veuillez saisir les premières lettres du libellé)
				                </td>
				                <td>
         				...
         				<table width=80%>            	
							...
							<% if  	(listeRechercheId.size()>0){%>
								<tr>
									<td colspan ="4" class="contenu">Cliquez sur un code Projet pour le sélectionner</td>
								</tr>
								<BR>
 								<tr>
					 				<td class="lib" width="25%" >Code Projet</td>
								...
								<logic:iterate id="element"  name="listeRechercheId"  length="<%=listeRechercheId.getCountInBlock()%>" 
									...
									type="com.socgen.bip.metier.InfosProjet"
									indexId="index"> 
									<% if ( i == 0) i = 1; else i = 0;%>
