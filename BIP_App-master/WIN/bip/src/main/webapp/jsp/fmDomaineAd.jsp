...
java.util.ArrayList list1 = new com.socgen.bip.commun.liste.ListeDynamique().getListeDynamique("domaine_npsi",hP); 
pageContext.setAttribute("choixDomaine", list1);
%>
  ...
  <tr> 
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td height="20" class="TitrePage">Tables - Mise &agrave; jour Domaine</td>
        </tr>
        <tr> 
          <td background="../images/ligne.gif"></td>
        </tr>
...
<html:hidden property="arborescence" value="<%= arborescence %>"/>
              <table cellspacing="2" cellpadding="2" class="tableBleu"   >
                ...
                <tr> 
                  <td    class="lib" colspan=2 align=center><b>Domaines</b></td>
                </tr>
                <tr> 
                  <td  colspan="2" align="center">
                  	<html:select property="code" styleClass="input" size="10"> 
   						<html:options collection="choixDomaine" property="cle" labelProperty="libelle" />
   					</html:select>
				  </td>
				</tr>
                <tr> 
