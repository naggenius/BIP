...
END VERIFIER_DPCOPI_AXE_METIER;
 ...
 PROCEDURE insert_dpcopi (p_dpcopi   IN  dossier_projet_copi.dp_copi%TYPE,
    ...
    */
         ...
         maj_dossier_projet_copi_logs (UPPER(p_dpcopi), l_user, 'DPCOPIAXEMETIER','',p_dpcopiaxemetier,'Création de l''axe métier DPCOPI');
   ...
   BEGIN
      ...
      END;
          ...
          UPDATE dossier_projet_copi SET libelle  = p_libelle,
                        ...
                        dpcopiaxemetier=p_dpcopiaxemetier
          WHERE dp_copi = UPPER(p_dpcopi)
         ...
         maj_dossier_projet_copi_logs (UPPER(p_dpcopi), l_user, 'DPCOPIAXEMETIER',old_dpcopiaxemetier,p_dpcopiaxemetier,'Modification de l''axe metier dpcopi');
