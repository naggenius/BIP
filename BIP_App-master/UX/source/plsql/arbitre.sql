   ...
   l_icpi10 := UPPER(substr( l_icpi, pos9+1 , pos10-pos9-1));
         ...
         OPEN p_curseur FOR
            SELECT c.clilib AS CLILIB,
                ...
                --Fin YNI
                -- KRA PPM 61919 §6.9 : ajout de ref_demande et le consommée annuel
                ,nvl2(p.dp_copi,nvl(dc.dpcopiaxemetier,nvl(p.projaxemetier,null)),nvl(p.projaxemetier,null)) as REF_DEMANDE
                -- ajout du consommée annuel de la ligne BIP                
