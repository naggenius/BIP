...
-- Modifiée le 24/11/2004  par Fiche 257   Evolution du référentiel compétence / prestation dans la BIP
-- 27/07/2006	JMA	:	TD 448 : cout standard 2 par métier
...
-- Modifiée le 2-/06/2010 Par YNI Fiche 970
...
IF l_odatval<1 THEN
	BEGIN
			...
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'identifiant ressource', NULL, p_ident, 'Création de la situation');
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'date valeur situation', NULL, p_datsitu, 'Création de la situation');
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'date départ situation', NULL, p_datdep, 'Création de la situation');
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code prestation', NULL, p_prestation, 'Création de la situation');
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code société', NULL, p_soccode, 'Création de la situation');
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code pôle/dpt/groupe', NULL, p_codsg, 'Création de la situation');
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code Chef de Projet', NULL, p_cpident, 'Création de la situation');
      Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'mode contractuel indicatif', NULL, p_mode_contractuel, 'Création de la situation');
...
ELSE
	   ...
	   FROM SITU_RESS
        ...
        AND TO_CHAR(datsitu,'yyyymmdd') = l_datval;
			...
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'date départ situation', TO_CHAR(l_old_datdep,'dd/mm/yyyy'), p_datdep, 'Modification de la situation');
			...
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code société',l_old_soccode, p_soccode, 'Modification de la situation');
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code pôle/dpt/groupe', TO_CHAR(l_old_codsg), p_codsg, 'Modification de la situation');
...
IF (l_oldatval!=l_datval) THEN
	...
	BEGIN
			...
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code société', NULL, p_soccode, 'Modification de la situation (date valeur situation : ' || l_datsitu ||')');
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code pôle/dpt/groupe', NULL, p_codsg, 'Modification de la situation (date valeur situation : ' || l_datsitu ||')');
	...
	--------------------------------------------------------------------
           BEGIN
				 ...
				 Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'date départ situation', p_datdep, TO_CHAR((TO_DATE(p_datsitu,'mm/yyyy')-1)), 'Modification de la situation');
	  ...
	  SELECT datdep,codsg,soccode,PRESTATION ,cpident, mode_contractuel_indicatif INTO
	   ...
	   FROM SITU_RESS
	      WHERE ident = TO_NUMBER(p_ident)
			...
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'date départ situation', TO_CHAR(l_old_datdep,'dd/mm/yyyy'), p_datdep, 'Modification de la situation (date valeur situation : '|| l_oldatval ||')');
			...
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code société',l_old_soccode, p_soccode, 'Modification de la situation (date valeur situation : '|| l_oldatval ||')');
			Pack_Ressource_L.maj_ressource_logs(p_ident, l_user, 'SITU_RESS', 'code pôle/dpt/groupe', TO_CHAR(l_old_codsg), p_codsg, 'Modification de la situation (date valeur situation : '|| l_oldatval ||')');
