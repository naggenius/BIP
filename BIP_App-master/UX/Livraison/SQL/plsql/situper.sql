...
FUNCTION verif_situ_ligcont_etendue(p_ident IN VARCHAR2,
                               p_datsitu    IN  VARCHAR2,
                               p_datdep     IN  VARCHAR2,
                               p_soccont IN VARCHAR2,
                               p_lresdeb IN DATE,
...
-- Function used by the report Ressources_active to detect compatibilite etendue
     ...
     CURSOR cur_situligne IS
      ...
      BEGIN
          ...
          ELSIF(l_count = 1) THEN
            ...
            IF((p_datsitu > p_lresdeb) or ((p_datdep is not null) and (p_datdep < p_lresfin))) THEN
              return 0;
            END IF;
...
END  verif_situ_ligcont_etendue;
