  ...
  PROCEDURE insert_struct_info ( 	p_codsg		IN VARCHAR2,
   ...
   BEGIN
	...
	BEGIN
      ...
      date_effet =    case when p_datferm is null then null else last_day(to_date('01/'||p_datferm,'DD/MM/YYYY')) end
		WHERE codsg 	= TO_NUMBER(p_codsg)
