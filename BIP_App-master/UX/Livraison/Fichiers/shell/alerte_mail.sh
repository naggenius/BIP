...
then
		...
		#BIP 183 - Information about absent of niveau file
		if [ $TYPE_MENSUELLE -eq 4 ]
                then
                        CORPS="Attention le fichier Niveaux des SG n’a pas été reçu "
        #BIP 183 - Information about absent of gershwin file
		elif [ $TYPE_MENSUELLE -eq 5 ]
                then
                        CORPS="Attention le fichier des absences Gershwin n’a pas été reçu "
        else
