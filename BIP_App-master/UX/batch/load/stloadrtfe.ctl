...
TRAILING NULLCOLS
(sgZoneId,cn,sgCustomId1,sn,givenname,sgLegalStatus,sgRtfeId,id,sgGroupId,C,L,mail,sgMailType
,telephoneNumber,sgCompany,sgServiceCode,sgServiceName,sgJob
,sgStructure,buildingName,roomNumber,postalAdress,postalCode,fax "SUBSTR(:fax,length(:fax)-19)",sgActivity,sgActivitycenter
,sgutiroleatt1 CHAR(4000),sgutiroleatt2 CHAR(4000),sgutiroleatt3 CHAR(4000),sgutiroleatt4 CHAR(4000)
,sgutiroleatt5 CHAR(4000),sgutiroleatt6 CHAR(4000),sgutiroleatt7 CHAR(4000))
