...
then
	...
	FILE_EXP_ENCOURS=$DIR_BATCH_DATA/$FILE_MENSUELLE_EXP_EN_COURS
	...
	then
			...
			PJ="$FILE_EXP_ENCOURS;EXP_encours.csv"
	...
	FILE_FACTINT=$DIR_BATCH_DATA/$FILE_MENSUELLE_FACTINT
	if [ -e $FILE_FACTINT ]
	then
